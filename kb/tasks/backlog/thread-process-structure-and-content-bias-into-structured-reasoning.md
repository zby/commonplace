...
- Related tasks/notes/docs:
  ...
  - Extractable Value #3 and #6 in `kb/sources/language-models-like-humans-show-content-effects-on-reasoning.ingest.md`
...
## Notes
- `human-writing-structures-transfer-to-llms-because-failure-modes.md` already carries some Lampinen-derived support, so this is not greenfield.
