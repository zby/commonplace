---
description: "Curated head for the theory-builder tag — systems that apply conjecture and refutation to stated theories: addressable and tentative theory, criticism, theory fit, program theory, reach-assessment"
...
Systems that apply Popper's conjecture and refutation to theories they state: the theories sit in localized units of natural or formal language, guide what the system does through what they say, meet criticism aimed at what they say, and the result of criticism shapes the next round. The defining note is [theory builder](../notes/definitions/theory-builder.md); whether such a builder learns is the hypothesis under test, not part of the definition. Notes here cover its theories, their criticism, and program theory; the search, evaluation, and retention loop belongs to [improvement-loop](./improvement-loop-README.md). A child of [self-improving-systems](./self-improving-systems-README.md).
...
- [Cost-sensitive formalisms for tentative theory search](../notes/cost-sensitive-formalisms-for-tentative-theory-search.md) — exploratory map of models that expose search budgets
...
- [Natural-language project state may specialize weight-resident search heuristics](../notes/natural-language-project-state-specializes-search-heuristics.md) — stated theory and history steer heuristics the model already holds
- [Methodology and its live theory fallback form a two-layer execution system](../notes/theory-and-methodology-form-a-two-layer-execution-system.md) — where theory still executes once methodology exists
- [Theory building and capacity building make the same kind of fallible commitment](../notes/theory-and-capacity-building-make-the-same-kind-of-commitment.md) — explanatory and constructive commitments differ in how they are retracted
- [Retained theories may improve sample efficiency under structured shifts](../notes/retained-theories-may-improve-sample-efficiency.md) — the open payoff conjecture for retaining theories
- [Citing retained theory at the decision point is a mediation trace](../notes/citing-retained-theory-at-the-decision-point-is-a-mediation-trace.md) — cheap evidence a theory was consumed, not that it was used well
- [A retained-theory intervention isolates one surface](../notes/retained-theory-intervention-isolates-one-explicit-surface.md) — what an ablation can show, and what it cannot
- [The 2026-08-30 Commonplace revision used retained theory to guide computational search](../notes/evidence/commonplace-revision-used-theory-guided-computational-search.md) — observed episode; the operator selected for global fit

## Related Tags

- [self-improving-systems](./self-improving-systems-README.md) — the parent: one way a system changes its own organization
- [improvement-loop](./improvement-loop-README.md) — the search and retention machinery; shares the theory-guided-search notes
- [software-factory](./software-factory-README.md) — an open-domain theory builder becomes a software house when new domains require changes to its production machinery
- [reflection](./reflection-README.md) — a reflective builder's method texts meet the same conditions
- [warranted-autonomy](./warranted-autonomy-README.md) — which of a builder's decisions computation can take without a human
- [continual-learning](./continual-learning-README.md) — learning over time, without the requirement to criticize stated content
