...
- [Elicitation requires maintained question-generation systems](../notes/elicitation-requires-maintained-question-generation-systems.md) - shows how inquiry processes decay when prompts stop generating discriminating questions
