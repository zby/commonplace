...
Output of `kb/work/agent-note-improvement/run-full-improvement-pass-on-note.md`: per-note subdirectories holding the compression-bundle review and the reconciled synthesis packet from a full improvement pass.
