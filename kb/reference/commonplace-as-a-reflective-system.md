...
- [Real self-improving systems occupy combinations no single rung captures](../notes/real-self-improving-systems-occupy-combinations-no-rung-captures.md) — rests-on: why reflective structure, dynamics, governance, and allocation stay distinct in the classification
