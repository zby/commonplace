...
- [ADR 069: collection contract bundles become one-time prototypes](./adr/069-collection-contract-bundles-become-one-time-prototypes.md) — see-also: preserves local text-contract variation without letting a collection redefine type-owned frontmatter semantics
