...
- [Artifact classification separates profile, content kind, lineage, and authority](../notes/a-knowledge-base-holds-theories-descriptions-and-prescriptions-with.md) — rests-on: separates truth-apt beliefs in design rationale from residual selections whose adoption records a commitment; Commonplace's proposal surface preserves both before adoption
