...
- [Selective revision needs a faithful rationale, not just a legible one](../notes/revision-guided-by-rationale-needs-faithfulness-not-just-legibility.md) — rests-on: the worse-than-absent asymmetry and the intervention test behind the faithfulness statement above
