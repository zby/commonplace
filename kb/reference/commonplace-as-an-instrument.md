...
- [Provenance warrants a decomposition's scope claim; only discriminating use earns it](../notes/provenance-warrants-a-decompositions-scope-claim-use-earns-it.md) — rationale: the warrant grades the worked instances occupy, and the reason a free choice supports no scope claim
