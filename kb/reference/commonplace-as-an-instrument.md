...
The route out of that limit is not more use; it is rationale retained at design time, which is what gives a transfer claim an antecedent to test. [Provenance warrants a decomposition's scope claim](../notes/provenance-warrants-a-decompositions-scope-claim-use-earns-it.md) — it does not earn it — and the repository carries one worked instance of each non-free warrant.
...
- [Provenance warrants a decomposition's scope claim; only discriminating use earns it](../notes/provenance-warrants-a-decompositions-scope-claim-use-earns-it.md) — rests-on: the warrant grades the worked instances occupy, and the reason a free choice supports no scope claim
