...
The route out of that limit is not more use; it is rationale retained at design time, which is what gives a transfer claim an antecedent to test. [Derivation and inheritance give a decomposition's scope claim its starting warrant](../notes/provenance-warrants-a-decompositions-scope-claim-use-earns-it.md) — warrant, not earning — and the repository carries one worked instance of each.
...
- [Only derivation and inheritance warrant a decomposition's scope claim; discriminating use earns it](../notes/provenance-warrants-a-decompositions-scope-claim-use-earns-it.md) — rests-on: the warrant grades the worked instances occupy, and the reason a free choice supports no scope claim
