...
- **Ontology warrant**: a freely chosen replacement carve is no better warranted than the freely chosen current one; the survey exists to make the revision derived or inherited rather than a second free choice ([rationale](../../notes/derivation-and-inheritance-give-starting-warrant-earns-scope.md)).
