...
- This is the predicted fourth instance of the taxonomy demotion pattern — rationale: [a universal knowledge framework demotes content taxonomies to defaults](../../../notes/a-universal-knowledge-framework-demotes-content-taxonomies-to-defaults.md) names the status/endorsement fusion as "one answerability relation hardwired one level too high."
...
- [A universal knowledge framework demotes content taxonomies to defaults](../../../notes/a-universal-knowledge-framework-demotes-content-taxonomies-to-defaults.md) — rationale: assertion force is one answerability relation among several; hardwiring one at the type level is the fusion this proposal undoes
...
- [A framework rule with a boundary-preserving rival is not an inherited constraint](../../../notes/a-framework-rule-with-a-boundary-preserving-rival-is-not-inherited.md) — grounds: names status/lifecycle enum values as a demoting choice, not an inherited constraint, the premise the cube analysis builds on
