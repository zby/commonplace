...
- [Atomic-step grounding bounds unquoted sources per note](./atomic-step-grounding-bounds-unquoted-sources-per-note.md) — adopted by ADR 082, 2026-08-27. The 344-note corpus measurement (eight notes over five sources, median seven distinct artifacts), the Quotes-confinement requirement on quote verification, and the free choices (N, fail-or-warn, snapshot-required counting, articles) behind the artifact-side bound.
