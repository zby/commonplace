...
- (2026-08-02) The later-episode compounding protocol now has its own note: [compounding is tested in later improvement, not by the accepting metric](../../notes/compounding-is-tested-in-later-improvement-not-by-the-accepting-metric.md) — displaced measures, uptake traces, and three baselines whose stronger-model arm carries this proposal's contamination force. The two target different quantities: that note tests whether a retained benefit helps produce later improvement; this proposal measures whether the framework earns its cost at all.
