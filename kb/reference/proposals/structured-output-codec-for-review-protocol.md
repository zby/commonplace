...
- [Claude Code dynamic workflows](../../agentic-systems/reviews/claude-code-dynamic-workflows.md) — abstracted-from: the schema-validated `agent()` option whose generalization is this proposal's trigger
