...
- [error correction works above chance with decorrelated checks](../../notes/error-correction-works-above-chance-oracles-with-decorrelated-checks.md) — rationale: set-valued judging can use decorrelated per-axis judges (coverage, non-redundancy, explanatory-reach) instead of one holistic score
