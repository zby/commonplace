...
Review sweep outputs — individual review files, summaries, and ranked tables — are the prototypical report: generated by scripts, regenerable in place, no authored claims. They live under `kb/reports/`.
...
**Harder:**
- Another top-level directory under `kb/` for the routing table to carry.
