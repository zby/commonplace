...
- **Ampliative traffic routes to the discovery lifecycle.** The coined compound [discovery lifecycle](../../notes/definitions/discovery-lifecycle.md) is the technical term for staged ampliative acceptance; traffic enters at its conjecture phase and never inherits accepted status from the sentence that states it. Bare "discovery" is ordinary English and no note title captures it.
