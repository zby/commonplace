...
- [Text contract](../../notes/definitions/text-contract.md) — operates-on: the definition note this decision created by renaming `register.md` and revising its contents
