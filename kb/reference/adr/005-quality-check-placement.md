...
See [ADR 010](./010-review-state-should-move-to-sqlite-once-reviews-leave-git-and.md) for why review execution became a scoped DB-backed exception to the repo's files-first design.
