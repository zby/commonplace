...
- [Link vocabulary — a resource for COLLECTION.md authors](./link-vocabulary.md) *(note)* - Label catalogue plus authoring guidance for COLLECTION.md authors writing outbound-linking rules; groups labels by register-of-origin (theoretical, descriptive, prescriptive, universal) and tells collection authors how to structure per-destination outbound blocks
