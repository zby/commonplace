...
- [qmd](./qmd.md) *(note)* - How commonplace uses qmd for optional semantic search, where its collection config and index state live, and why Codex needs extra writable roots for qmd-backed queries
