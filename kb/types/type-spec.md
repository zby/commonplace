...
- [representational form](../notes/definitions/representational-form.md) — grounds: the symbolic/natural-language split this section names is that definition's inspection-method rule (test symbolic, read natural-language content) applied to the validator vs. the type-conformance reviewer
