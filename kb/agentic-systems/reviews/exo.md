...
- [Reflective theory refinement needs interpretation, retention, and independent read-back](../../notes/reflective-theory-refinement-needs-interpretation-and-retention.md) — rests-on: the operative-path functions Exo partly supplies and the independent evaluation its acceptance gate leaves to the model
