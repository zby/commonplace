...
- [A complete theory path does not establish improved capacity](../../notes/a-complete-theory-path-does-not-establish-improved-capacity.md) — rests-on: the operative-path functions Exo partly supplies and the independent evaluation its acceptance gate leaves to the model
