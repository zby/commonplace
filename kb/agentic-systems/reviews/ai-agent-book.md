...
tags: [computational-model, context-engineering, agent-memory, evaluation, self-improving-systems]
---
...
- `commonplace-validate kb/agentic-systems/reviews/ai-agent-book.md`: **PASS (clean)**; frontmatter, title, filename, local links, proposal boundary, and note schema all passed with no warnings or failures.
