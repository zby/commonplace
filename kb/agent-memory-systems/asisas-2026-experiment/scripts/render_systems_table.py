#!/usr/bin/env python3
"""Render the frozen ASISAS-2026 human-readable comparison table.

Emits ``asisas-2026-experiment/systems-table.md`` from the experiment-local
``systems.csv``. Generated, not hand-maintained -- rebuild after systems.csv
changes:
...
OUT = EXPERIMENT_DIR / "systems-table.md"
...
def rel_link(review_file: str) -> str:
    """Path of a review relative to the experiment root (where this page lives)."""
    return "./" + review_file
