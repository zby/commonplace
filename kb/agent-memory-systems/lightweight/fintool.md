...
- [incrementally constrained files defer centralized schema commitment until write invariants stabilize](../../notes/files-defer-centralized-schema-commitment-until-invariants-stabilize.md) — is-evidence-for: Fintool reports S3 as source of truth with PostgreSQL as a derived index for fast queries
