...
- [Ingest: Large Language Model Agents Are Not Always Faithful Self-Evolvers](../../sources/large-language-model-agents-are-not-always-faithful-self-evolvers.ingest.md) — evidence: evaluates G-Memory directly and finds raw experiences remain more behaviorally binding than condensed memory
