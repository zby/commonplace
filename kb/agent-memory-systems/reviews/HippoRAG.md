...
- [agent-memory-needs-discoverable-composable-trusted-knowledge-under-bounded-context](../../notes/agent-memory-needs-discoverable-composable-trusted-knowledge-under-bounded-context.md) - contrasts: HippoRAG improves discoverability of support passages but does not supply the composability and trust surfaces expected from an agentic KB.
