...
- [inspectable substrate, not supervision, defeats the blackbox problem](../../notes/inspectable-substrate-not-supervision-defeats-the-blackbox-problem.md) — exemplifies: deployment scripts, plans, and agent-facing docs all stay in a substrate that another agent can inspect and revise
