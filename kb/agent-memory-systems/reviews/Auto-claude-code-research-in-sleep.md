...
**Trace-extracted self-improvement is proposed, staged, and gated.** Hook logging appends skill, prompt, tool, session, and reviewer-call events to project and global `.aris/meta/events.jsonl` logs. `/meta-optimize` reads those logs to propose SKILL.md/default/workflow patches, and `/meta-apply` is the privileged human-invoked landing gate ([tools/meta_opt/log_event.sh](https://github.com/wanshuiyin/Auto-claude-code-research-in-sleep/blob/f0dde3eee942e6630f2f62d78daafcd8c52ed033/tools/meta_opt/log_event.sh), [tools/meta_opt/check_ready.sh](https://github.com/wanshuiyin/Auto-claude-code-research-in-sleep/blob/f0dde3eee942e6630f2f62d78daafcd8c52ed033/tools/meta_opt/check_ready.sh), [skills/meta-optimize/SKILL.md](https://github.com/wanshuiyin/Auto-claude-code-research-in-sleep/blob/f0dde3eee942e6630f2f62d78daafcd8c52ed033/skills/meta-optimize/SKILL.md), [skills/meta-apply/SKILL.md](https://github.com/wanshuiyin/Auto-claude-code-research-in-sleep/blob/f0dde3eee942e6630f2f62d78daafcd8c52ed033/skills/meta-apply/SKILL.md)).
...
- **Representational form:** `natural-language` `symbolic` — SKILL.md instructions, reviewer prompts, wiki pages, reports, and query packs are natural-language; manifests, JSONL edges/events/traces, run-state JSON, helper scripts, installers, tests, and MCP server code are symbolic.
...
**Distilled form:** `natural-language` `symbolic` — Trace analysis produces natural-language reports and symbolic diffs/manifests; accepted changes become modified SKILL.md natural-language, helper contracts, defaults, or workflow rules.
...
**Survey position.** ARIS belongs in the trace-to-instruction-artifact family. It strengthens the claim that trace-learning is safer when the learner can propose but not acquit its own changes. Its distinctive split is that the trace-extracted artifact is initially advisory and only becomes system-definition material after a separate landing gate.
...
- [Use trace extraction as meta-learning](../../notes/agent-memory-requirements/use-trace-extraction-as-meta-learning.md) - exemplifies ARIS's usage-log-to-skill-patch loop.
