...
> Replaced 2026-05-16. See [xMemory](./xMemory.md) for the current review.
...
- [an-agentic-kb-maximizes-contextual-competence-through-discoverable-composable-trusted-knowledge](../../notes/an-agentic-kb-maximizes-contextual-competence-through-discoverable.md) — contrasts: xMemory delivers discoverable derived artifacts but lacks composable claim structure and trusted curation
