...
- [Agent statelessness means the context engine should inject context automatically](../../notes/agent-statelessness-means-the-context-engine-should-inject-context-automatically.md) — exemplifies: WUPHF makes every agent turn stateless and reintroduces continuity through broker-selected tools and memory surfaces
