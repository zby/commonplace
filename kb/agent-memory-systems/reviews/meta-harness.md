...
**Distilled form:** `natural-language` `symbolic` - The durable distilled artifacts are hypotheses, reports, skill-following proposer outputs, JSON manifests/summaries/frontiers, Python candidate harnesses, and prompt templates.
