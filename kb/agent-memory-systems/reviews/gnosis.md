...
- **Representational form:** `natural-language` `symbolic` — Entry text and doctrine are natural-language; IDs, topics, related IDs, timestamps, command schemas, topic normalization, ID-prefix resolution, FTS queries, snippets, and BM25 ranking are symbolic structures.
