...
> Replaced 2026-04-12. See [dynamic-cheatsheet](./dynamic-cheatsheet.md) for the current review.
...
The follow-up paper [Ingest: Large Language Model Agents Are Not Always Faithful Self-Evolvers](https://arxiv.org/html/2601.22436v2) evaluates Dynamic Cheatsheet directly and makes this maintenance-risk more concrete: agents in that setup often remain weakly sensitive to interventions on condensed experience. In other words, carrying forward a cheatsheet can improve the system while still failing to make the cheatsheet strongly behaviorally binding.
...
- [memory management policy is learnable but oracle-dependent](../../notes/memory-management-policy-is-learnable-but-oracle-dependent.md) — sharpens: Dynamic Cheatsheet is the artifact-side counterpart to weight-learning systems that also depend on strong recurring task signals
- [deploy-time learning](../../notes/deploy-time-learning-is-the-missing-middle.md) — sharpens: this system sits squarely in the deploy-time artifact-update space, using persistent prompt-state rather than weights
- [Ingest: Large Language Model Agents Are Not Always Faithful Self-Evolvers](https://arxiv.org/html/2601.22436v2) — evidence: evaluates Dynamic Cheatsheet directly and finds condensed cheatsheet-style experience has limited causal influence under intervention
