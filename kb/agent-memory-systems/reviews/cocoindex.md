...
- [substrate class, backend, and artifact form are separate axes that get conflated](../../notes/axes-of-substrate-analysis.md) — extends: CocoIndex makes the split between source substrate, internal tracking backend, and exported artifact form unusually explicit
