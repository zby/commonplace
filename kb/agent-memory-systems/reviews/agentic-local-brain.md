...
**Collected Markdown files.** Storage substrate: files under `~/.knowledge-base/1_collect/...` by default. Representational form: body text plus YAML frontmatter. Lineage: imported from local files, webpages, bookmarks, papers, emails, or authored notes. Behavioral authority: knowledge artifacts; they become RAG context only after indexing or lexical search.
