...
> Replaced 2026-05-16. See [Memori](./Memori.md) for the current review.
...
- [Mem0 Memory Layer](https://github.com/mem0ai/mem0) — compares: both use automated extraction into external memory records, but Memori's inspected repo foregrounds SDK interception, entity/process/session scoping, and conversation-summary attachment
