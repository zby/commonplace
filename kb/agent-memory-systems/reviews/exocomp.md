...
- [Inspectable substrate, not supervision, defeats the blackbox problem](../../notes/inspectable-substrate-not-supervision-defeats-the-blackbox-problem.md) — foundation: Exocomp's best design choice is keeping the coordination surface in ordinary readable files even when the higher-level workflow is incomplete
