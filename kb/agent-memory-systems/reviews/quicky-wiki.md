...
- **Representational form:** `mixed` - Symbolic relational tables, FTS indexes, IDs, confidence numbers, timestamps, event types, JSON metadata, and links carry prose claim statements, source titles, summaries, tags, and LLM-generated answers
