...
> Replaced 2026-05-16. See [Context Constitution](./context-constitution.md) for the current review.
...
- [Flat memory predicts specific cross-contamination failures that are empirically testable](../../notes/flat-memory-predicts-specific-cross-contamination-failures-that-are.md) — tension: identity, memory, and operational guidance still risk being mixed across weakly typed agent-owned context layers
