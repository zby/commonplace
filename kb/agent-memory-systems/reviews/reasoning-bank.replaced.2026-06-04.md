...
> Replaced 2026-06-04. See [ReasoningBank](./reasoning-bank.md) for the current review.
...
- Whether selected-memory faithfulness is tested through ablations or post-action audits; that would make the pushed read-back mechanism more trustworthy as a reusable pattern.
