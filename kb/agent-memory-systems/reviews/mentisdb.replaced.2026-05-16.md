...
> Replaced 2026-05-16. See [MentisDB](./mentisdb.md) for the current review.
...
- [agent-orchestration-needs-coordination-guarantees-not-just-coordination-channels](../../notes/agent-orchestration-needs-coordination-guarantees-not-just.md) — sharpens: shared memory is a coordination channel, but MentisDB adds attribution and integrity more than semantic conflict resolution
