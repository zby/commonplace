...
- [substrate class, backend, and artifact form are separate axes that get conflated](../../notes/axes-of-substrate-analysis.md) — sharpens: Virtual Context is still in the symbolic artifact substrate even though its backend is a service-managed store rather than repo files
