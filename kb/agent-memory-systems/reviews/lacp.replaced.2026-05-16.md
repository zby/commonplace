...
> Replaced 2026-05-16. See [LACP](./lacp.md) for the current review.
...
- [Inspectable artifact, not supervision, defeats the blackbox problem](../../notes/inspectable-artifact-not-supervision-defeats-the-blackbox-problem.md) — exemplifies: even the heavier governance layer stays mostly local, file-backed, and inspectable
