...
> Replaced 2026-05-16. See [Autocontext](./autocontext.md) for the current review.
...
- [constraining-and-distillation-both-trade-generality-for-reliability-speed-and-cost](../../notes/constraining-and-distillation-both-trade-generality-for-reliability.md) — exemplifies: constraint-mode prompts make the constraining explicit at generation time, aggressive per-scenario optimisation contrasts with our cross-domain distillation
