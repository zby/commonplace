...
- [Symbolic context engineering is bounded by symbol availability](../../notes/symbolic-context-engineering-is-bounded-by-symbol-availability.md) - relates: project, session, source-agent, date, role, provenance, and message ids provide explicit retrieval symbols alongside inferred lexical/vector relevance.
