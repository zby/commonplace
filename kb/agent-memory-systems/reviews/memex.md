...
- **Representational form:** `mixed` — Memex combines prose Markdown pages and prompts with symbolic SQLite rows, command schemas, tool allowlists, filesystem layout, and JSON job results.
