...
- [axes-of-substrate-analysis](../../notes/axes-of-substrate-analysis.md) - exemplifies: KBLaM combines flat key/value fact artifacts, JSON/NumPy/checkpoint backends, and an opaque learned adapter/query-head substrate.
