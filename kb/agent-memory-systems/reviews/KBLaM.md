...
- [substrate-class-backend-and-artifact-form-are-separate-axes-that-get-conflated](../../notes/substrate-class-backend-and-artifact-form-are-separate-axes-that-get-conflated.md) - exemplifies: KBLaM combines flat key/value fact artifacts, JSON/NumPy/checkpoint backends, and an opaque learned adapter/query-head substrate.
