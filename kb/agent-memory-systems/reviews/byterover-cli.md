...
- [Inspectable substrate, not supervision, defeats the blackbox problem](../../notes/inspectable-substrate-not-supervision-defeats-the-blackbox-problem.md) — foundation: ByteRover's strongest design choice is keeping the memory substrate inspectable even while the runtime grows sophisticated
