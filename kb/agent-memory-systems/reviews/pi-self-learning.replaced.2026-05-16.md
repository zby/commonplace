...
> Replaced 2026-05-16. See [Pi Self-Learning](./pi-self-learning.md) for the current review.
...
- [inspectable-artifact-not-supervision-defeats-the-blackbox-problem](../../notes/inspectable-artifact-not-supervision-defeats-the-blackbox-problem.md) — the shadow git repo keeps memory inspectable, though separation from the project repo reduces discoverability
