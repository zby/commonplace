...
> Replaced 2026-05-16. See [SignetAI](./signetai.md) for the current review.
...
- [agent statelessness means the context engine should inject context automatically](../../notes/agent-statelessness-means-the-context-engine-should-inject-context.md) — exemplifies: Signet's hooks inject context at lifecycle boundaries instead of waiting for the user to rebuild state
