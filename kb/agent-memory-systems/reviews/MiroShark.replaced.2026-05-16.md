...
> Replaced 2026-05-16. See [MiroShark](./MiroShark.md) for the current review.
...
- [Inspectable artifact, not supervision, defeats the blackbox problem](../../notes/inspectable-artifact-not-supervision-defeats-the-blackbox-problem.md) — parallels: the simulator remains reviewable because belief updates, bridge logic, and report tooling live in inspectable code rather than hidden prompt state
