...
> Replaced 2026-05-16. See [Siftly](./siftly.md) for the current review.
...
- [a-functioning-kb-needs-a-workshop-layer-not-just-a-library](../../notes/a-functioning-kb-needs-a-workshop-layer-not-just-a-library.md) — enables: Siftly's import jobs and stage counters are concrete workshop artifacts for ingestion state
- [automating-kb-learning-is-an-open-problem](../../notes/automating-kb-learning-is-an-open-problem.md) — extends: Siftly is a concrete narrow-scope automation pipeline we can compare against our open questions
- [deterministic-validation-should-be-a-script](../../notes/deterministic-validation-should-be-a-script.md) — foundation: deterministic preprocessing before LLM calls follows the same hard-oracle trajectory
- [instructions-are-typed-callables](../../notes/instructions-are-typed-callables.md) — extends: Siftly's stages behave like typed callables composed into a pipeline
