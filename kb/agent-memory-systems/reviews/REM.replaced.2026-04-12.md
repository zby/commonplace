...
> Replaced 2026-04-12. See [REM](./REM.md) for the current review.
...
- [distillation](../../notes/definitions/distillation.md) — exemplifies: the consolidation pipeline is a distillation operation (episodes compressed into shorter facts under a context budget), though the transformation is shallow (LLM prompt asking for "durable facts" from clustered episodes)
