...
**Distilled form:** `natural-language` `symbolic` — The distilled outputs are natural-language final answers/reports plus symbolic run events, result JSON, status fields, and trace/report lineage records.
