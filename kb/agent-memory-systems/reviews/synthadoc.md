...
- **Representational form:** `mixed` - Prose Markdown is combined with YAML frontmatter, `[[wikilinks]]`, citation markers, lifecycle enums, routing lists, skill manifests, SQLite schemas, vectors, and exported graph formats.
