...
- [Axes of artifact analysis](../../notes/axes-of-artifact-analysis.md) — sharpens: CrewAI's database backend still stores symbolic artifacts; the backend choice is separate from substrate class
