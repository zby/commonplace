...
- [Axes of substrate analysis](../../notes/axes-of-substrate-analysis.md) — sharpens: CrewAI's database backend still stores symbolic artifacts; the backend choice is separate from substrate class
