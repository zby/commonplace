...
> Replaced 2026-05-16. See [Virtual Context](./virtual-context.md) for the current review.
...
- [agent memory systems landscape](../README.md) — navigation hub for the agent-memory-systems collection
...
- [Axes of artifact analysis](../../notes/axes-of-artifact-analysis.md) — sharpens: Virtual Context is still symbolic in representational form even though its storage substrate is a service-managed store rather than repo files
...
- [inspectable artifact, not supervision, defeats the blackbox problem](../../notes/inspectable-artifact-not-supervision-defeats-the-blackbox-problem.md) — contrasts: Virtual Context keeps symbolic artifacts, but they are inspectable mainly through tooling and schema, not directly as human-authored files
