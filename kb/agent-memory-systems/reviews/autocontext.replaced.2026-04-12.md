...
- [constraining-and-distillation-both-trade-generality-for-reliability-speed-and-cost](../../notes/constraining-and-distillation-both-trade-generality-for-reliability.md) — exemplifies: autocontext constrains aggressively per scenario (high reliability/speed within domain) while commonplace distils broadly (generality across domains), demonstrating the trade-off in practice
