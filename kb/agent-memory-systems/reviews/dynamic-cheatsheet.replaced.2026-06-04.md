...
Replaced by [dynamic-cheatsheet.md](./dynamic-cheatsheet.md) on 2026-06-04.
...
**Read-back:** `push` — With coarse cheatsheet injection in cumulative mode and instance-targeted embedding push in retrieval modes; no independent agent pull path is implemented
