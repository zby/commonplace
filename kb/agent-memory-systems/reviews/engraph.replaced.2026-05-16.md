...
> Replaced 2026-05-16. See [engraph](./engraph.md) for the current review.
...
- [An agentic KB maximizes contextual competence through discoverable, composable, trusted knowledge](../../notes/an-agentic-kb-maximizes-contextual-competence-through-discoverable.md) — contrasts: engraph is strong on discoverability, thinner on composability and trustworthiness in the knowledge-design sense
