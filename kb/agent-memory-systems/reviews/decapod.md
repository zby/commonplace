...
- [Use trace-derived extraction](../../notes/agent-memory-requirements/use-trace-derived-extraction.md) - relates: Decapod turns operational traces into lessons, summaries, graph nodes, proof baselines, and promotion records while preserving raw evidence.
