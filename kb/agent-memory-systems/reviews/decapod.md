...
**Distilled form:** `natural-language` `symbolic` — Distilled outputs are natural-language lessons, summaries, prompts, specs, and knowledge bodies plus symbolic metadata, hashes, graph nodes, workunit/proof records, promotion events, and manifests. I did not find distributed-parametric learned state.
