...
- [Agent statelessness means the context engine should inject context automatically](../../notes/agent-statelessness-means-the-context-engine-should-inject-context-automatically.md) - exemplifies: every Phantom session is a fresh process; continuity comes from prompt-block auto-include plus explicit Qdrant queries, not chat history.
