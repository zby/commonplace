...
- [axes-of-artifact-analysis](../../notes/axes-of-artifact-analysis.md) — exemplifies: substrate-class is symbolic artifacts (not weights); backend is filesystem + Chroma; artifact form is executable JavaScript — three clearly separable choices
