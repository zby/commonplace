...
- [agent-memory-needs-discoverable-composable-trusted-knowledge-under-bounded-context](../../notes/agent-memory-needs-discoverable-composable-trusted-knowledge-under-bounded-context.md) - contrasts: Agent-S captures rich evidence but does not turn latest-runtime traces into discoverable, governed KB artifacts.
