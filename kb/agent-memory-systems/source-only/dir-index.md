...
- [Incremental Self-Improvement](./incremental-self-improvement.md) *(note)* - Source-only coverage note for Schmidhuber's incremental self-improvement paradigm, a reward-gated self-modification system for learning learning strategies
