...
- [Designing a Memory System for LLM-Based Agents](../notes/designing-agent-memory-systems.md) — rationale: synthesizes the survey's repeated techniques into a constructive architecture around trace retention, promotion targets, validation oracles, and activation surfaces
