...
The source also supplies the organizational precursor for [factory-level continual learning](../notes/a-software-factory-learns-when-production-experience-changes-reusable-machinery-used-later.md). Feedback flows from solution developers to factory developers, but human factory developers interpret it and decide how reusable production machinery changes. The account therefore establishes feedback-supported factory development, not a system-determined learning process.
