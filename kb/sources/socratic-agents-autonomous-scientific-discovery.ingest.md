...
Review the existing [theory-refinement definition](../notes/definitions/theory-refinement.md) against AHOIS as a candidate supervised external-domain example, requiring an identifiable explanation–revision–decision episode before promoting it as evidence and keeping durable retention explicitly unestablished.
