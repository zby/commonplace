...
- [recognition, not linking, is the hard problem in knowledge systems](../notes/recognition-not-linking-is-the-hard-problem-in-knowledge-systems.md) — **extends**: the adjacency-vs-connection distinction maps to this note's recognition depth hierarchy; embedding adjacency is "shared feature" level, curated links require deeper recognition.
- [links](../tags/links-README.md) — **reference material**: practitioner validation of propositional link semantics.
- [tags](../tags/README.md) — **reference material**: practitioner validation of propositional links over embedding adjacency.
...
- [Agent memory needs discoverable, composable, trusted knowledge under bounded context](../notes/agent-memory-needs-discoverable-composable-trusted-knowledge-under.md) — **validates (trustworthiness)**: credibility erosion from noisy links threatens the trustworthiness property. When an agent cannot trust links, composability fails.
