...
- [tags](../tags/README.md) — validates: listed in Reference material; provides empirical grounding for context-loading categories
- [learning-theory](../tags/learning-theory-README.md) — validates: listed in Reference material; commit-level evolution confirms continuous learning through versioned artifacts
...
2. [deploy-time-learning-the-missing-middle](../notes/retained-artifacts-enable-persistent-deployment-time-adaptation.md) — **validates**: the paper's conclusion that AI context files are "maintained software artifacts" that are "versioned, reviewed, quality-assured, and tested" is the deploy-time learning thesis stated as an empirical finding.
