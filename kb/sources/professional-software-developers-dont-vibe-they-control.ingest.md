...
- **[programming-practices-apply-to-prompting](../notes/underspecification-and-indeterminism-complicate-programming-for.md)** -- *grounds*: the paper's central finding is large-scale empirical evidence for this note's theoretical argument. Quote S88 ("I prompted by applying the lessons of software engineering to narrative") is a direct statement of the thesis.
...
- **[deploy-time-learning-the-missing-middle](../notes/retained-artifacts-enable-persistent-deployment-time-adaptation.md)** -- *exemplifies*: plan files, context files, and user rules are deploy-time learning artifacts -- durable, inspectable adaptations persisting across sessions.
