...
- **[programming-practices-apply-to-prompting](../notes/underspecification-and-indeterminism-complicate-programming-for-prompts-in-distinct-ways.md)** -- *grounds*: the paper's central finding is large-scale empirical evidence for this note's theoretical argument. Quote S88 ("I prompted by applying the lessons of software engineering to narrative") is a direct statement of the thesis.
