...
The source is a conceptual foundation for [tentative theory](../notes/definitions/tentative-theory.md) and [conjectural learning](../notes/definitions/conjectural-learning.md). Its tentative theory is a proposed solution open to criticism; it does not stipulate separately editable repair locations. Commonplace now treats that structure separately as [addressability](../notes/definitions/addressable-theory.md).
...
Commonplace's conjectural-learning definition maps onto part of this cycle: revising an existing theory in response to empirical cases is one way to attempt error elimination. Popper also includes criticism without an empirical intervention, replacement of theories, and the discovery of new problems, all admitted by the current definition when formulated criticism improves capacity for future action. His content can also include consequences no thinker has yet grasped. Neither a successful patch nor a retained document exhausts the growth of knowledge he describes. The essay supports separating tentative status and conjectural learning from addressability.
...
Maintain the separation among [tentative theory](../notes/definitions/tentative-theory.md), [conjectural learning](../notes/definitions/conjectural-learning.md), and [addressable theory](../notes/definitions/addressable-theory.md) while preserving Popper's distinction between linguistic criticism and formalization.
