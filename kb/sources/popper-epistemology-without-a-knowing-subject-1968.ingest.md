---
description: "Popper distinguishes objective conjectural contents from acts of thought and linguistic forms, making criticism central to learning without equating it with formalization."
source: https://doi.org/10.1016/S0049-237X(08)71204-7
captured: "2026-09-19"
capture: pdftotext
capture_scope: full-source
doi: "10.1016/S0049-237X(08)71204-7"
genre: conceptual-essay
snapshot_sha256: 9274a4c820f5b7e8c7d4e2ee8dd1a4946e1c17b334b1b8bf31b82cdbfe0bfff0
ingested: "2026-09-19"
...
The source is a conceptual foundation for [tentative theory](../notes/definitions/tentative-theory.md) and [theory builder](../notes/definitions/theory-builder.md), which cites it for condition 1 (a descriptive language as a condition of criticism), condition 2 (action guided by objective knowledge), and the [reflective qualifier](../notes/definitions/theory-builder.md#qualifiers). Its tentative theory is a proposed solution open to criticism; it does not stipulate separately editable repair locations. Commonplace treats that finer structure as [addressability](../notes/definitions/addressable-theory.md), a design commitment above condition 1's minimum.
...
The unread-book and computer-generated-table examples supply a contrast with [the evidence that a system used and criticized a theory](../notes/a-complete-theory-path-does-not-establish-improved-capacity.md). Potential intelligibility suffices for the content's objective status in Popper's account. A system that consumes and criticizes a theory (conditions 2 and 3) is a further requirement for calling it a theory builder, and improvement in capacity is a separate learning claim beyond membership. A retained object can therefore count as objective knowledge without establishing that any particular system learned from it.
...
The [theory-builder definition](../notes/definitions/theory-builder.md) takes this cycle as its schema, restricted to the scientific level. Its four conditions follow Popper's account there: theories stated in a descriptive language (condition 1), guiding action (condition 2), eliminated or revised through criticism that may be argument as well as experiment (condition 3), and kept so that new problems start later work (condition 4). Replacement of a theory whole and the discovery of new problems count, and no successful patch is required; whether the process improves capacity for future action is a separate question the definition leaves to test. His content can also include consequences no thinker has yet grasped, so neither a retained document nor a successful revision exhausts the growth of knowledge he describes. The essay supports separating tentative status and builder membership from finer addressability: condition 1 asks only that some unit say something, and a finer grain is a design commitment above that minimum.

The source makes two different contributions to the occasion. It directly supports rejecting formalization as a prerequisite for critical theory work: section 6 makes informal proofs and argumentative language central. It does not support simply dropping externalization from Popper's account of scientific criticism. Section 4 explicitly requires an exosomatic descriptive language, meaning language developed outside the body as a tool; written language is a further development. This is broader than a separately stored software artifact, but it remains a substantive language requirement. His broader biological and subjective accounts allow learning beyond that scientific case. The definition settles the question this leaves for artificial systems: criticism needs a stated unit to aim at (condition 1), and its result must shape the next conjecture (condition 4). How long that result persists is graded, not a condition: stated criticism that revises a theory within one episode and is then discarded makes a theory builder at the lowest grade, and discarding it ends that builder.

Our further inference concerns [the effective update space](../notes/learning-inside-a-fixed-decomposition-inherits-its-mistakes.md). Popper's evolving languages, new problems, and new mathematical constructions suggest that learning can change what it is able to formulate. They offer a reason to question a permanently fixed hypothesis vocabulary, not evidence that a particular learner can revise its own representation or escape its available operations. The essay specifies no computational update space and compares no implementations.

## Extractable Value

1. **Separate conjectural status from repair structure.** Popper's proposed solution remains tentative because it is open to criticism, not because it has a particular storage form or edit interface. This provides a basis for reviewing where the old theory-refinement definition attached operational addressability to the broader epistemic term. [deep-dive]
...
Maintain the separation among [tentative theory](../notes/definitions/tentative-theory.md), [theory builder](../notes/definitions/theory-builder.md), and [addressable theory](../notes/definitions/addressable-theory.md): tentative status and builder membership rest on condition 1's minimum, not on finer addressability. Preserve Popper's distinction between linguistic criticism and formalization.
