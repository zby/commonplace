...
description: Two working modularizations of the same KWIC index program, indistinguishable by running them, distinguished only by whether module boundaries hide the design decisions likely to change — the information-hiding criterion.
captured: 2026-07-27
capture: pdf-read
...
Author: D.L. Parnas
Source: https://www.win.tue.nl/~wstomv/edu/2ip30/references/criteria_for_modularization.pdf
Date: December 1972 (Communications of the ACM, Volume 15, Number 12)

Programming Techniques Editor: R. Morris
...
A lucid statement of the philosophy of modular programming can be found in a 1970 textbook on the design of system programs by Gouthier and Pont [1, ¶I0.23], which we quote below:
