...
Write a note titled **"Agentic adaptation taxonomies need an artifact-substrate axis"** connecting to [treat-continual-learning-as-substrate-coevolution.md](../notes/treat-continual-learning-as-substrate-coevolution.md), [continual-learning-open-problem-is-behaviour-not-knowledge.md](../notes/continual-learning-open-problem-is-behaviour-not-knowledge.md), [memory-management-policy-is-learnable-but-oracle-dependent.md](../notes/memory-management-policy-is-learnable-but-oracle-dependent.md), and [skills-derive-from-methodology-through-distillation.md](../notes/skills-derive-from-methodology-through-distillation.md). It would argue that A1/A2/T1/T2 usefully classify optimization locus and supervision signal, but agent-operated KB methodology also needs to classify the durable learned artifact: weights, prose, symbolic code, external tools, memory stores, and skill libraries have different inspectability, update cost, verification surfaces, and maintenance loops.
