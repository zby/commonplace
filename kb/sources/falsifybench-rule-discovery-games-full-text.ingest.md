...
This supplies several ingredients of [conjectural learning](../notes/definitions/conjectural-learning.md). Hypotheses are explicit, semantic membership supplies criticizable consequences, and traces show revision following informative tests. Natural-language hypotheses permit inspectable changes of category or scope. However, the experiment does not establish that the declared hypothesis causally mediates the next decision or that the process of conjecture and formulated criticism improves future capacity. Selective repair and preservation of useful prior knowledge are separate properties left unisolated. The benchmark measures no cross-game retention and does not revise the testing machinery. No weight updates are part of the reported mechanism.
