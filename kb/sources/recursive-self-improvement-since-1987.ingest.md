...
In Commonplace terms, software that represents and modifies its own learning procedure offers a route to reflective self-modification. It does not by itself establish [conjectural learning](../notes/definitions/conjectural-learning.md). That process requires criticism of what a formulated, operative theory says to improve future capacity. Reward-selected program changes and neural fitting need not expose such a theory or formulate criticism of its content. The Gödel construction does expose a formal self-representation, but proving a beneficial switch under current premises differs from revising those premises because empirical cases challenge them. The retrospective leaves that latter operation unspecified.
