...
snapshot_sha256: 7264a3ae45dc4bc91e59de5397e92e39a778f60b48f8a1000fb1e47fca715da1
ingested: "2026-09-18"
...
This is broader than Commonplace's [theory refinement](../notes/definitions/theory-refinement.md). Improving a neural predictor by fitting can satisfy the source's mechanism without exposing separately editable explanatory commitments. Revising an explicit predictive program could overlap with theory refinement if cases expose consequences and guide localized repair, but the compression objective does not require that operation. The source adds an explicit account of how learning can select its own future evidence; it does not supply a diagnosis procedure for repairing a KB theory.
