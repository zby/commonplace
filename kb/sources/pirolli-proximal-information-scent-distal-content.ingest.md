...
- [Charting the knowledge-access problem beyond RAG](../notes/knowledge-access-architecture-must-be-evaluated-end-to-end.md) — is-evidence-for: a navigation-mode decomposition validated against coded protocols
