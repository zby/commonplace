...
snapshot_sha256: 92f5bf3e1528baac992c7c3b7eafa89700abecf3d0e2f9cea0c27910bcfb305d
ingested: "2026-08-31"
...
Update [Theory building has distinct epistemic, structural, and implementation precedents](../notes/theory-building-has-distinct-precedents.md) to replace its direct DOI citation with a `(snapshot required)` link to this ingest and expand the EITHER case with the proof-guided repair mechanism, fixed Horn update space, and absence of reflective or later-learning evidence.
