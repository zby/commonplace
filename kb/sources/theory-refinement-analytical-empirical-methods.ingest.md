...
Update [the lineage account for reflective theory refinement](../notes/reflective-theory-refinement-has-three-separate-lineages.md) to replace its direct DOI citation with a `(snapshot required)` link to this ingest and expand the EITHER case with the proof-guided repair mechanism, fixed Horn update space, and absence of reflective or later-learning evidence.
