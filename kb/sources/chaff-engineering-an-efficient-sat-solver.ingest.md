...
snapshot_sha256: 81e07dd3891542fccf7f9ca70602a1226683c72f72b96b8fdb8eee4c0f317601
ingested: "2026-09-24"
...
In Commonplace terms this is adaptation of search control through operative retained results, not [conjectural learning](../notes/definitions/conjectural-learning.md). A conflict clause is formulated symbolic content and is operative through what it says. However, it is a sound consequence of the formula, so it is closed to criticism: the solver would never criticize or revise it as a tentative theory; deletion removes it for memory reasons, not because it was found wrong. VSIDS counters are not formulated theories at all. The case is therefore useful as a contrast: it shows retained failure explanations steering search when those explanations are guaranteed correct, which is the condition fallible natural-language explanations lack.
