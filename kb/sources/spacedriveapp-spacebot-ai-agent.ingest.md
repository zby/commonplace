...
**Index membership:**
- [related-systems-index](../agent-memory-systems/index.md) -- **extends**: Spacebot adds a new position (Rust-level process separation, concurrent multi-user design) that no existing entry covers.
