...
- [methodology-enforcement-is-constraining](../notes/methodology-enforcement-is-constraining.md) — the source's component list (system prompts, tools, hooks/middleware, orchestration logic) maps directly onto the constraining gradient
...
- [codification-and-relaxing-navigate-the-bitter-lesson-boundary](../notes/codification-and-relaxing-navigate-the-bitter-lesson-boundary.md) — the model/harness co-training feedback loop is codify/relax operating at the training boundary
