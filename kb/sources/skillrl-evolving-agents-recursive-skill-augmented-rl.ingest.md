...
snapshot_sha256: 03e977e783831359114209026fbf63e547586b7ef289310d1eb76a2fca1ff4bc
ingested: "2026-06-30"
...
Write a note titled **Skill banks couple readable artifacts and policy learning**. It should use SkillRL as the main evidence, compare against SkillOpt, AgeMem, Agent Workflow Memory, SkillWeaver, and Amazon SAGE, and connect to [Treat continual learning as substrate coevolution](../notes/treat-continual-learning-as-representational-form-coevolution.md), [Continual learning requires governing behaviour-changing writes, not just storing content](../notes/continual-learning-requires-governing-behaviour-changing-writes.md), and [Use Trace Extraction As Meta-Learning](../notes/agent-memory-requirements/use-trace-extraction-as-meta-learning.md).
