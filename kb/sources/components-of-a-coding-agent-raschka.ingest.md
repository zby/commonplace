...
snapshot_sha256: 15974823b396cbb1cbb6d33f7f22df60704a058a0df86444f64d0fd653d93d19
ingested: "2026-04-05"
...
2. **No failure-mode analysis.** Raschka describes what each component does when it works. He does not describe when these mechanisms fail — when does frontloaded repo context mislead? When does transcript reduction discard something the agent needed? When does subagent delegation lose coherence? The KB's notes on [soft degradation](../notes/soft-degradation-often-binds-before-the-hard-cap-when-evidence-fits.md) and context bloat address these failure modes; Raschka's account is purely success-path.
