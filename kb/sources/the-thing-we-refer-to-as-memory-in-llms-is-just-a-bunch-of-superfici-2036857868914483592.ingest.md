...
Source: the-thing-we-refer-to-as-memory-in-llms-is-just-a-bunch-of-superfici-2036857868914483592.md
Captured: 2026-03-25
...
**Cross-contamination:** [flat-memory-predicts-specific-cross-contamination-failures-that-are-empirically-testable](../notes/flat-memory-predicts-specific-cross-contamination-failures-that-are-empirically-testable.md) predicts the multi-agent scenario failures deepfates describes.
