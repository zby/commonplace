...
**Review context:** The [agentic-memory-systems-comparative-review](../agent-memory-systems/agentic-memory-systems-comparative-review.md) grounds its analysis of the agency dimension on Letta as the primary exemplar of agent-self-managed memory. Letta is one of eleven systems analyzed, occupying the unique position of high agency + block-based storage + context-first architecture.
