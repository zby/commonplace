...
snapshot_sha256: 05715d839523e20777a37bc4ad77d65b5b29d5be64588b43ca7916c4ab66d39a
...
The mapping to the [theory-builder definition](../notes/definitions/theory-builder.md) is partial. Programs in a formal language meet condition 1, and their editable parts give finer [addressability](../notes/definitions/theory-builder.md#addressability). Frozen programs meet condition 2, because later searches consume their content as callable code or search bias. Condition 4 is met in the retention sense: frozen solvers are taken up on later, different tasks, as the Hanoi trace shows. Condition 3 fails and decides the verdict. Candidates are selected by verification outcome without a formulated reason for failure bearing on their content, which the definition classes as trial and error, and a frozen program is never criticized for what it says once kept. The construction specifies its search fully, so this is a property of the design, not an unobserved step. Addressability and self-directed search changes alone do not make OOPS a theory builder. Improved later search cost is a separate learning claim, supported here only for the Hanoi transfer.
