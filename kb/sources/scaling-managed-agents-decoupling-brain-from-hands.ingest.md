...
Update [agent-runtimes-decompose-into-scheduler-context-engine-and-execution-substrate](../notes/agent-runtimes-decompose-into-scheduler-context-engine-and-execution.md): add Managed Agents as a new practitioner evidence section arguing that stable agent runtime interfaces should preserve session, computation, and capability boundaries while allowing harness implementation churn as model behavior changes.
