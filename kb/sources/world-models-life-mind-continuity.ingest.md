...
snapshot_sha256: 04e3669b02fda9e6cad6816a53073320551816b71de2efefbb549b3e91caca57
...
EMPA's symbolic models are a plausible comparison for the [theory-builder definition](../notes/definitions/theory-builder.md). As summarized, they meet condition 1, since objects and interaction rules are stated symbolically, and condition 2, since they choose encounters, subgoals, and plans. This editorial does not detail how the models are revised, so condition 3 is unestablished, and it does not say whether revised models carry across games, so condition 4 is unestablished. The verdict stays open at condition 3 pending the primary study. Symbolic objects and rules could also support finer [addressability](../notes/definitions/addressable-theory.md), but their symbolic form alone does not establish selective diagnosis and repair. The reported sample-efficiency advantage is a separate learning claim about the compound architecture. Self-prediction regularization and dynamical entrainment are adaptation of weights or dynamics; they fail condition 1. No definition change follows from placing all these mechanisms under world modelling.
