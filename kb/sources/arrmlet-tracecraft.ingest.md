...
**Index membership:** [related-systems-index](../agent-memory-systems/related-systems-index.md) — tracecraft would be the first entry focused purely on coordination infrastructure rather than memory/knowledge management.
