...
Relative to [conjectural learning](../notes/definitions/conjectural-learning.md), this demonstrates theory use and local revision of proposed tests more clearly than criticism of the domain theory that improves future capacity. The main hypothesis supplies the task and remains the claim being validated. Its Self-Refinement prompt is consequently not evidence of a reflective system learning conjecturally: critiquing a test proposal does not by itself revise a causally connected theory of the system's own organization.
...
- **Changeable tests and changeable theories are distinct capabilities.** [quick-win] Use POPPER as a concrete case when assessing what a learning system can revise: generated tests and executable analyses change while the supplied main hypothesis remains fixed. This sharpens the distinction between consequence testing and conjectural learning without requiring a new learning category.
...
Review [Conjectural learning](../notes/definitions/conjectural-learning.md) against POPPER as a boundary case, checking that its distinction between applying a theory, revising tests, and revising the theory remains explicit.
