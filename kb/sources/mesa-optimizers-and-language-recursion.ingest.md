...
Write a note titled "Compression analogies need a boundary test" connecting to [bitter-lesson-boundary](../notes/fixed-artifacts-split-into-exact-specs-and-proxy-theories.md), [first-principles-reasoning-selects-for-explanatory-reach-over-adaptive-fit](../notes/first-principles-reasoning-selects-for-explanatory-reach-over-adaptive-fit.md), and [llm-learning-phases-fall-between-human-learning-modes](../notes/llm-learning-phases-fall-between-human-learning-modes.md). It would argue that cross-domain compression analogies are only useful when they survive two checks: the mechanism transfers across substrate differences, and it predicts whether the target domain sits on the scale-friendly or calculator-friendly side of the bitter lesson boundary.
