...
snapshot_sha256: 518ce74f0f6aba4881fb50b2f8f8160cf130b9ac0909b7744ea5098be00152dd
ingested: "2026-03-12"
...
- [bitter-lesson-boundary](../notes/exact-implementation-does-not-validate-a-requirement.md) — **exemplifies**: the "Big Blob of Compute Hypothesis" is the bitter lesson stated as corporate strategy.
- [deploy-time-learning-the-missing-middle](../notes/retained-artifacts-enable-persistent-deployment-time-adaptation.md) — **extends**: Amodei's three mechanisms (pre-training, RL, in-context) are exactly the "training" and "in-context" timescales; his claim that they suffice sharpens the question of what deploy-time learning uniquely provides.
