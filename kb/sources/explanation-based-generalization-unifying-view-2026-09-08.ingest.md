...
Revise the EBG paragraph in [Conjectural learning has distinct precedents](../notes/conjectural-learning-has-distinct-precedents.md) to identify EBG as proof-guided operationalization under a supplied theory, explicitly separating that precursor from empirical theory refinement.
