...
description: "Erlang/OTP runtime code-replacement rules: module-level current and old versions coexist, switching requires a qualified call, and a third load purges lingering old code."
captured: 2026-08-19
capture: web-fetch
