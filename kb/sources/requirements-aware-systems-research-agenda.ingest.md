...
Revise the runtime-self-modeling section of [the lineage account for reflective theory refinement](../notes/reflective-theory-refinement-has-three-separate-lineages.md) to cite this ingest alongside the earlier requirements-reflection ingest and distinguish this paper's five-part research agenda from the shared, still-unevaluated runtime-object architecture.
