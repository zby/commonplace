...
Revise the runtime-self-modeling section of [Theory-mediated system learning combines runtime self-modeling with empirical theory refinement](../notes/theory-mediated-learning-joins-self-modeling-and-theory-refinement.md) to cite this ingest alongside the earlier requirements-reflection ingest and distinguish this paper's five-part research agenda from the shared, still-unevaluated runtime-object architecture.
