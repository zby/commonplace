...
Revise the runtime-self-modeling section of [Conjectural learning has distinct precedents](../notes/theory-building-has-distinct-precedents.md) to cite this ingest alongside the earlier requirements-reflection ingest and distinguish this paper's five-part research agenda from the shared, still-unevaluated runtime-object architecture.
