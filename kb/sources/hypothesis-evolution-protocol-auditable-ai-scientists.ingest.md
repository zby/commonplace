...
This partly instantiates [theory refinement](../notes/definitions/theory-refinement.md): candidate explanations have predictions, separately addressable hypotheses can be revised, and empirical cases influence what is retained in later explanations. A belief change alone is not refinement of explanatory content. The reported replacement and merging of mechanisms provide stronger evidence than a trajectory of confidence values. However, the paper does not systematically test whether revisions preserve useful prior predictions, and hypothesis lineage alone does not establish that every child repairs an identified error.
