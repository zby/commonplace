...
snapshot_sha256: 8f6cc3cd4a0cb876bc79748d5e48f9a703ecb31f41f182fb8fc3bd04026615dd
ingested: "2026-04-20"
...
**The central claim is easy to overextend.** "General methods that scale win" is a high-reach heuristic, not a universal law. The KB's [fixed-artifact distinction](../notes/exact-implementation-does-not-validate-a-requirement.md) already marks the boundary: calculators, validators, legal move generators, and other exact-spec artifacts do not become bad just because learned systems scale. Treating all hand-built structure as doomed would erase the exact-spec side of the boundary.
