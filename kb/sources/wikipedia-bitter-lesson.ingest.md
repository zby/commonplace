...
4. **[Crystallisation Is Continuous Learning](../notes/crystallisation.md)** — creates tension. Crystallisation builds domain-specific verification infrastructure, which the bitter lesson predicts will be dissolved by scale. The unresolved question: is verification infrastructure domain-specific (doomed) or general-purpose scaffolding (durable)?
