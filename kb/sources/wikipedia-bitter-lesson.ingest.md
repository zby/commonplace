...
1. **[The bitter lesson stops at calculators](../notes/fixed-artifacts-split-into-exact-specs-and-proxy-theories.md)** -- grounds. This source is the direct origin of the concept the note analyses. The note already links to this source. The source provides the empirical examples (chess, Go, speech, vision) that the calculator/vision-feature distinction organises.
