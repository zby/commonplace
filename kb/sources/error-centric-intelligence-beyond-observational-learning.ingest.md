...
snapshot_sha256: 6951c70640d6db8bdcc736ee39d134d7dc440813b113584bf866b22066bcb90f
ingested: "2026-09-19"
...
The paper is a conceptual comparator for [conjectural learning](../notes/definitions/conjectural-learning.md): both tie learning to criticism that changes future capacity, though the KB requires only that the theory be open to criticism and credits improvement to conjecture and criticism together. Thomas emphasizes changing what a learner can represent and test, while Commonplace separately chooses a recurrent causal path through retained, addressable theories. Its unreachable-error question sharpens [learning inside a fixed decomposition](../notes/learning-inside-a-fixed-decomposition-inherits-its-mistakes.md) by naming intervention semantics and invariance assumptions as possible revision targets. Neither connection supplies measured evidence that the proposed loop works.
...
This partly maps onto [conjectural learning](../notes/definitions/conjectural-learning.md). Revising a formulated mechanism against criticism can fit the process; introducing an entirely new representational apparatus can fit too when it is an operative formulated theory open to criticism and the process improves capacity for future action. Separately editable mechanisms support [addressability](../notes/definitions/addressable-theory.md), which is a distinct property. Thomas's explanatory knowledge has stronger conditions than the KB's tentative theory: it must concern mechanisms and support counterfactual or interventional reasoning. The source's broad definition of learning also permits durable internal state without Commonplace's chosen retained-theory arrangement. Neither term should be substituted for the other.
...
Review [conjectural learning](../notes/definitions/conjectural-learning.md) against a single explicit question: does the paradigm require its representation and criticism machinery to be revisable, or is that a separate capability to assess for each theory builder?
