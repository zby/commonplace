...
7. [three-space-agent-memory-maps-to-tulving-taxonomy](../notes/three-space-agent-memory-echoes-tulvings-taxonomy-but-the-analogy-may-be-decorative.md) -- **exemplifies (suggestively)**: the author's described split between research/content, values/decisions/failures, and operational task state resembles the semantic / episodic / procedural separation.
