...
- [a-good-agentic-kb-maximizes-contextual-competence](../notes/an-agentic-kb-maximizes-contextual-competence-through-discoverable-composable-trusted-knowledge.md) — **validates (trustworthiness)**: credibility erosion from noisy links threatens the trustworthiness property. When an agent cannot trust links, composability fails.
