...
Relative to [conjectural learning](../notes/definitions/conjectural-learning.md), this is a proposal for improving the error-detection input to revision. It does not demonstrate that an operative theory, open to formulated criticism of what it says, improves future capacity through conjecture and criticism. The two instructed analyses seek different conclusions; their divergence is not evidence of one learner correcting a theory. No model-weight update or persistent behavioral improvement is evaluated.
