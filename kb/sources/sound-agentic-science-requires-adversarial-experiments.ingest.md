...
Relative to [conjectural learning](../notes/definitions/conjectural-learning.md), this is a proposal for improving the error-detection input to revision. It does not demonstrate that formulated criticism of what an operative theory says improves future capacity. The two instructed analyses seek different conclusions; their divergence is not evidence of one learner correcting a theory. No model-weight update or persistent behavioral improvement is evaluated.
