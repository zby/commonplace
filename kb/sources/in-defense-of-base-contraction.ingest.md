...
snapshot_sha256: 38bf165bb60341e285b1d7f0db343c1ed690f541cf99ee58f26a2e3120bac401
ingested: "2026-09-17"
...
The source's adaptation mechanism is contraction or revision over an explicit belief representation. Its key distinction is between the current consequences and the base that generates them. The base identifies independently held propositions; logical closure supplies their derivative consequences; and a selection mechanism resolves cases where removing a target requires choosing among basic propositions. This only partly maps to [conjectural learning](../notes/definitions/conjectural-learning.md). The explicit commitments and consequence relation can make a theory operative and open to criticism, but Hansson does not establish that the process of conjecture and criticism improves capacity for future action. Separately editable commitments are an [addressability](../notes/definitions/addressable-theory.md) property, not a condition of conjectural learning. The paper adds a representation condition to Commonplace's account: repeated revision may require preserving dependency structure that an extensionally equivalent theory state omits. Its examples support the need for that distinction in the cases shown; they do not establish that base structure plus a background selector is sufficient for every repeated-change process.
