...
This does not establish [conjectural learning](../notes/definitions/conjectural-learning.md). Accepting labels and clusters need not formulate a theory of membership or criticize what that theory says. A curator could perform such reasoning, but the proposed interaction does not make it observable, and improved future capacity is not demonstrated. The source adds a candidate feedback design rather than evidence for revising the definition.
