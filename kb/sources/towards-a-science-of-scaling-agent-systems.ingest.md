...
- **research/voooooogel-multi-agent-future.md** — Partially contradicts the "multi-agent is the future" thesis. Overall mean MAS improvement is -3.5%; multi-agent wins only for specific task types.
