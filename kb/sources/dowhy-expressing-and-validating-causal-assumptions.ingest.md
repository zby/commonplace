...
Keep this source as the cautionary citation in [Formal systems can assess reach through causal and proof obligations](../notes/formal-systems-can-assess-reach-through-causal-and-proof-obligations.md) for the assumption boundary of causal reach assessment; no separate promotion is needed now.
