...
- [interpretation, retention, and independent read-back in reflective theory refinement](../notes/reflective-theory-refinement-needs-interpretation-and-retention.md) — shifts Naur's human theory-holder into an LLM-plus-artifact system boundary while preserving the theory-building claim
