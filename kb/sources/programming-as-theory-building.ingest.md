...
- [interpretation, retention, and independent read-back in reflective theory refinement](../notes/a-complete-theory-path-does-not-establish-improved-capacity.md) — shifts Naur's human theory-holder into an LLM-plus-artifact system boundary while preserving the theory-building claim
