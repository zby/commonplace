...
snapshot_sha256: 78a80c61767667b202ba35a36445de0ce4b61ee93cebaf273fe557235ec880c5
...
This source is the strongest empirical basis currently found for [RLM's model-authored REPL orchestration](../notes/rlm-has-the-model-write-ephemeral-orchestrators-over-sub-agents.md): it ties symbolic state and programmatic sub-calls to measured length and cross-domain transfer, rather than only explaining the mechanism. It also operationalizes [soft context degradation](../notes/soft-degradation-often-binds-before-the-hard-cap-when-evidence-fits.md) as a positive harness objective—shape every individual call to remain locally in-distribution. The evidence strengthens the RLM placement in the KB's [symbolic-work persistence comparison](../notes/rlm-tendril-and-llm-do-place-symbolic-work-at-different-persistence.md), while leaving that note's cross-run accumulation question untouched. [Fractal](../agentic-systems/reviews/fractal.md) is the closest code-grounded system instance already covered.
