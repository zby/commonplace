...
- [deploy-time-learning-the-missing-middle](../notes/deploy-time-learning-is-the-missing-middle.md) (exemplifies): the thread's "practices haven't changed; the penalty has" argument is deploy-time learning in practitioner language. Better artifacts improve later runs without any weight update.
