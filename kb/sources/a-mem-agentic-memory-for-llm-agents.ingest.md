...
snapshot_sha256: fc7cdf349f575a0a3aa32b434f1ef958f074ce67c72437a74198a588587053cd
ingested: "2026-03-09"
...
- [learning-theory](../tags/learning-theory-README.md) — reference material in Memory & Architecture section: flat single-space design as test case for three-space separation
- [tags](../tags/README.md) — reference material: empirical evidence for boiling cauldron mutations and scaling data for embedding-based linking
- [links](../tags/links-README.md) — reference material: empirical counterpoint on embedding-based link generation succeeding on QA benchmarks
...
- [Agentic memory systems comparative review](../agent-memory-systems/agentic-memory-systems-comparative-review.md) — is-evidence-for: A-MEM is one of the systems analyzed across the current shared architectural axes
- [Notes Without Reasons ingest](./agentic-note-taking-23-notes-without-reasons-202689418851669643.ingest.md) — contradicts (on evaluation): the "adjacency is not connection" critique applies directly to A-MEM's untyped links, but they measure different things
- [AgeMem ingest](./agentic-memory-learning-unified-long-term-and-short-term.ingest.md) — sibling: both agent memory systems; AgeMem learns when to use operations through RL while A-MEM uses hand-crafted heuristics
