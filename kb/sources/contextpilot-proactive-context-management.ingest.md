...
The reported learning does not establish [conjectural learning](../notes/definitions/conjectural-learning.md). Plans and prose memories could contain operative conjectures, but the evaluation does not establish criticism of what those formulations say or attribute improvement to such criticism. Weight updates and mutable prose alone settle neither presence nor absence of that process.
