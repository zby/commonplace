...
snapshot_sha256: ddc7047180148b0c485f03eae3f6541d29a2b763110a0cb93ee43752d3be10b4
ingested: "2026-09-17"
...
On the paper's terms, adaptation is an operation over a theory already closed under a fixed consequence relation. Contraction removes a proposition while preserving selected maximal portions of the prior theory; revision first contracts enough to accommodate the new proposition and then adds it. Relative to the [theory-builder definition](../notes/definitions/theory-builder.md), this supplies a rigorous family of change operators and preservation constraints, but only a partial mapping. A theory stated as a set of propositions meets condition 1, although closure under consequence hides which propositions are basic. AGM's selection function expresses which remainder sets are preferred without explaining how evidence criticizes what a proposition says, generates candidate repairs, or selects among them; the framework therefore does not show condition 3, the deciding condition. Consumption and retention for later problems (conditions 2 and 4) lie outside a formal account of operators and stay unestablished rather than failed. Its representation theorems establish equivalence between postulates and formal constructions, not that either construction improves capacity for future action.
