...
5. **Curated specs outperform raw API references on occasional capabilities** -- L2 specs encode canonical recipes, order constraints, and runtime footguns that raw signatures omit. The artifact is not merely a shorter reference, but a use-shaped capability description for an agent performing a task. [just-a-reference]
