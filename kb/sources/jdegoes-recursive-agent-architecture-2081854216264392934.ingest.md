...
Add this snapshot as an `evidenced-by` link from [Deploy-time learning is the missing middle](../notes/deploy-time-learning-is-the-missing-middle.md), with a counterpoint phrase distinguishing the article's one-way prose-to-middleware thesis from Commonplace's reversible coevolution of prompts and code.
