...
This maps to retained evidence maintenance and context engineering. It does not establish [conjectural learning](../notes/definitions/conjectural-learning.md): the demonstrated operation classifies relationships between explicit dialogue claims; it does not show a formulated theory that guides later decisions and is open to criticism of what it says. The experiments use a fixed backbone and supply no demonstrated feedback loop that learns a better consolidation policy from answer errors.
