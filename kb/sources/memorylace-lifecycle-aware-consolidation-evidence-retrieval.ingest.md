...
This maps to retained evidence maintenance and context engineering. It does not establish [conjectural learning](../notes/definitions/conjectural-learning.md): the demonstrated operation classifies relationships between explicit dialogue claims, rather than criticizing what a formulated theory says and carrying the result into later decisions. The experiments use a fixed backbone and supply no demonstrated feedback loop that learns a better consolidation policy from answer errors.
