...
- [Learning by learning by theory refinement may improve sample efficiency under structured shifts](../notes/retained-theories-may-improve-sample-efficiency.md) — is-evidence-for: this paper is the shift-difficulty caveat that paragraph already rests on
