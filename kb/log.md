...
- kb/notes/symbolic-scheduling-over-bounded-llm-calls-is-the-right-model-for-agent-orchestration.md: ConvexBench and MAKER added as academic exemplars; Spacebot's cortex remains the strongest production case and should be referenced once the related-system note exists
