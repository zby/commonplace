...
- kb/notes/research/voooooogel-multi-agent-future.md: the note has no frontmatter type or areas fields; also the "Concrete Implementation: Spacebot" section was added as an appendix but is disconnected from the main argument structure
...
- kb/notes/reliability-dimensions-map-to-oracle-hardening-stages.md: references a note "approvals-guard-against-llm-mistakes-not-active-attacks" that does not exist — dangling link
...
- kb/notes/research/voooooogel-multi-agent-future.md: still has no frontmatter type field (noted previously but still unfixed)
