...
This note is the cluster's synthesis. Its component claims — the loop's three functions, addressability, methodological closure, oracle-bounded warrant — are each argued in a linked note; what is added here is their composition: read together, they describe a single movement, and the graded sense just defined names its direction.
