...
- [constraining and distillation both trade generality for reliability, speed, and cost](./constraining-and-distillation-both-trade-generality-for-reliability-speed-and-cost.md) — grounds: the trade-off codification enacts — not addressed in the body
...
- [Eric Evans: AI Components for a Deterministic System](../sources/eric-evans-ai-components-deterministic-system.ingest.md) — exemplifies: Evans' modeling/classification split is a worked example where all four lenses yield different verdicts on two halves of the same system
