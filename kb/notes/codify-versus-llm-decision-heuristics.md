...
- [constraining and distillation both trade generality for reliability, speed, and cost](./constraining-and-extraction-both-trade-generality-for-reliability.md) — grounds: the trade-off codification enacts — not addressed in the body
