...
| [Learning by learning by theory refinement may improve sample efficiency](./learning-by-theory-refinement-may-improve-sample-efficiency.md) | Gives a reason explicit theories might help under structured shifts | That the advantage exists at system scale or beats direct search |
