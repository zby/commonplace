...
- [Revision guided by rationale needs faithfulness, not just legibility](./selective-revision-needs-a-faithful-rationale-not-just-a-legible-one.md) — contrasts: examines repair that uses rationale as a diagnostic guide; a seed can reconstruct that guide without retaining every local explanation
