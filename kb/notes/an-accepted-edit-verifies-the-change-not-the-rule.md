...
- [Moen, Foundation and History of the PDSA Cycle](https://deming.org/wp-content/uploads/2020/06/PDSA_History_Ron_Moen.pdf) — evidenced-by: decades-old corroboration from quality improvement — one improving test is not enough; predicting improvement under future conditions is a separate judgment the test never performed
