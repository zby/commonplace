...
- [design methodology — borrow widely, filter by first principles](./programming-patterns-get-a-fast-pass-but-other-borrowed-ideas-must-earn-first-principles-support.md) — grounds: first-principles filtering IS selecting for explanatory reach; this note explains why that filter works
