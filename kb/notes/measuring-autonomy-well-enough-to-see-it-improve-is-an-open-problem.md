...
- [Human-inclusive boundaries make reflection cheap; autonomy is the discriminating gradient](./human-inclusive-boundaries-make-reflection-cheap.md) — grounds: the per-function, non-scalar grading this note takes as its starting point and finds insufficient for comparison
...
- [Four independent gradings place a self-improving system](./four-independent-gradings-place-a-self-improving-system.md) — see-also: autonomy is one of four independent gradings this note's problem is scoped to
