...
The concrete case is the retired `write-agent-memory-system-review` skill, which delegated review-drafting to a fresh sub-agent worker.
...
- [write-agent-memory-system-review skill](https://github.com/zby/commonplace/blob/70c0ff32c7d1c6be3eda4846d23bb22e843cd261/kb/instructions/write-agent-memory-system-review/SKILL.md) — see-also: the frozen historical skill whose delegated worker exhibited the leak and carried the reactive mitigation
