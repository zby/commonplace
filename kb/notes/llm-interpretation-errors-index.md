...
- [knowledge-possession-does-not-imply-contextual-activation](./knowledge-possession-does-not-imply-contextual-activation.md) — relevant knowledge can be present but remain unelicited; activation failure appears when probe retrievability is high but spontaneous emergence is low
