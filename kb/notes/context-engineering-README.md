...
- [A context-operation interface bounds the projections its policy can realize](./context-operation-interface-bounds-context-policy.md) - separates structural projection reach from policy success within one interface
