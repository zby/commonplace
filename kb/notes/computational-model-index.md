...
- [Prompt-limited systems should assemble context rather than inherit transcripts](./prompt-limited-systems-should-assemble-context-rather-than-inherit-transcripts.md) - Agent systems doing recurring work should treat prompts as assembled projections of explicit state, making selection and distillation architectural work.
