...
- [llm sdks unlock full power by exposing the loop](./llm-sdks-unlock-full-power-by-exposing-the-loop.md) — the implementation-level claim: tool calls are not enough unless the SDK exposes state progression and recursion to application code
