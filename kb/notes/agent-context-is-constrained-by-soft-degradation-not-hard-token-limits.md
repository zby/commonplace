...
- [GSM-DC ingest](https://arxiv.org/html/2505.18761v2) — exemplifies (volume, irrelevant-context mechanism): power-law error scaling with distractor count in math reasoning
- [Web agent benchmark ingest (Chung et al., 2025)](https://arxiv.org/html/2512.04307v1) — exemplifies (volume, irrelevant-context mechanism): agent-level catastrophic degradation from injected irrelevant task sequences; iRAG provides only modest relief
