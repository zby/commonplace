...
- [Theory refinement may improve sample efficiency under structured shifts](./learning-by-theory-refinement-may-improve-sample-efficiency.md) — grounds: supplies the conditional reason to try explicit theory as working state
