...
- [Theory refinement may improve sample efficiency under structured shifts](./learning-by-theory-refinement-may-improve-sample-efficiency.md) — extends: puts the formal routes developed here alongside the natural-language route, as two ways of discharging the same assessment
