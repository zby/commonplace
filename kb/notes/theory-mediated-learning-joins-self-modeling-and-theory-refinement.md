...
- [A research program for learning software factories](../articles/reachability-conjecture-the-llm-stays-fixed-the-software-house-learns.md) — context: states the combined program and its proposed interventions
