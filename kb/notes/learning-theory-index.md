...
- [Designing a Memory System for LLM-Based Agents](./designing-agent-memory-systems.md) - Requirements map for realistic agent memory systems: direct creation, import, evidence retention, contracts, activation, promotion, authority, lifecycle, compiled views, and evaluation
