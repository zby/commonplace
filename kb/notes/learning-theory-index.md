...
- [Designing a Memory System for LLM-Based Agents](./designing-agent-memory-systems.md) - Needs-focused requirements map for realistic agent memory systems: direct memory creation, trace-derived meta-learning, activation, promotion, authority, lifecycle, and evaluation
