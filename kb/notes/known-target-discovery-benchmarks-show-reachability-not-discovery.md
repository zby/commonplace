...
- [discovery is seeing the particular as an instance of the general](./discovery-is-seeing-the-particular-as-an-instance-of-the-general.md) — connects: known-target benchmarks test whether a system can reconstruct a general insight from supplied particulars
