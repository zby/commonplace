...
- [Self-improvement compounds through reflective leverage, not autonomy](./self-improvement-compounds-through-reflective-leverage-not-autonomy.md) — extends: the conversion candidates named here are leveraged changes — improvements to the pathway that make later episodes need fewer interventions
