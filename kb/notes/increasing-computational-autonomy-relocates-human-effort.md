...
- [Bainbridge, Ironies of Automation](../sources/ironies-of-automation.md) — evidence: the industrial precedent — automation leaves the operator the residue the designer could not automate, transforming the role rather than removing it
