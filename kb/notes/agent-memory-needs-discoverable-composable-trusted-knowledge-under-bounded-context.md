...
- [Designing a Memory System for LLM-Based Agents](./designing-agent-memory-systems.md) — extends: derives full memory-system requirements from contextual competence, consumer failure modes, artifact roles, and retrieval's limits
