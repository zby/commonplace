...
- Stated generally, the trajectory is a conjecture about human-operated agentic improvement systems, [Commonplace among them](../reference/commonplace-as-a-reflective-system.md); the closing-loop notes carry its evidence and the measurement caveats. This note supplies the boundary-topological vocabulary those notes' "displacement" and "relocation" language was reaching for.
