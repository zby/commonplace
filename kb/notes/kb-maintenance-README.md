...
- [stale-indexes-reduce-discovery-when-they-suppress-fallback-search](./indexes-lower-recall-when-they-suppress-retrieval-that-would-find-more.md) — an apparently complete, incomplete index lowers route-specific recall when it suppresses a more complete search
