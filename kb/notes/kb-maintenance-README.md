...
- [indexes-lower-recall-when-they-suppress-retrieval-that-would-find-more](./indexes-lower-recall-when-they-suppress-retrieval-that-would-find-more.md) — an apparently complete index lowers route-specific recall when it suppresses retrieval that would find more
