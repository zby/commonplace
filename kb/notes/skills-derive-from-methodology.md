...
- [codification: the missing middle](./retained-artifacts-enable-persistent-deployment-time-adaptation.md) — distinguishes: codification involves a phase transition in medium; skill derivation does not
