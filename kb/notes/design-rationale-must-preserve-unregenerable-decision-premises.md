...
- [Naur binds program theory to humans through the premise that machines only follow rules](./naur-binds-theory-to-humans-via-premise-that-machines-follow-rules.md) — grounds: why Naur's argument leaves the interpreter/premise split open, and why his compiler case names the premises this note's test retains
