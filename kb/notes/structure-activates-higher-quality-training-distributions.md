...
- [agentic code reasoning](https://arxiv.org/html/2603.01896v2) — grounds: 5-12pp gains from semi-formal templates provide partial empirical support; Sonnet's non-improvement on code QA surfaces a boundary condition
- [content effects on reasoning tasks](https://academic.oup.com/pnasnexus/article/3/7/pgae233/7712372) — grounds: CoT reduces content bias without degrading familiar performance; content effects survive scaling and instruction tuning, supporting structural intervention as permanent architecture
