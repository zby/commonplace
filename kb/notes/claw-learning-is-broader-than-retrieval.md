...
- [three distinct mechanisms](../notes/agentic-systems-learn-through-three-distinct-mechanisms.md) — grounds: the artifact-accumulation model of learning applies, but action-oriented learning needs different artifact types than note/link mutations
