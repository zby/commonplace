...
- [A Model for Types and Levels of Human Interaction with Automation](../sources/model-types-levels-human-interaction-automation.md) — evidenced-by: the external per-function allocation precedent, whose within-function level scale is deliberately not inherited
