...
- **Retention form — how is improvement held?** Operative, cumulative, or addressable, [since reflection buys addressability](./reflection-buys-addressability.md). Free end: any retention that steers. Costly end: retention the loop can read, criticize, selectively revise, and transfer.
...
- **Autonomy — who performs the pathway?** Assessed per function of the improvement pathway against a declared boundary, [since human-inclusive boundaries make reflection cheap](./human-inclusive-boundaries-make-reflection-cheap.md). Free end: bare autonomy — in a proposal-selection pathway, any gate can be handed to a fallible judge tomorrow. Costly end: warrant, [since warranted autonomy is bounded by oracle reach](./warranted-autonomy-is-bounded-by-oracle-reach.md).
