...
- [maintenance operations catalogue](./maintenance-operations-catalogue-should-stage-stable-procedures.md) — operationalizes: the catalogue lists what needs scaling; this note argues it must scale proportionally with generation
