...
- [Theory-mediated self-improvement needs interpretation, retention, and independent read-back](./reflective-theory-refinement-needs-interpretation-and-retention.md) — extends: requires the same theory to guide change, receive outcome read-back, be revised, and affect later operation
...
- [Theory refinement may improve sample efficiency under shifts](./theory-refinement-may-improve-sample-efficiency-under-shifts.md) — extends: predicts the directional negative transfer that makes a wrong-theory arm the discriminating test
