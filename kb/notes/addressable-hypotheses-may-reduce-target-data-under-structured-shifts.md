...
- [Reflective self-improvement changes how a system generalizes, not only what it knows](./reflective-self-improvement-changes-how-a-system-generalizes.md) — grounds: defines the learned inductive commitment and its reach, and locates both — with addressability — at the specific level of bias, the only level any differential advantage can touch
