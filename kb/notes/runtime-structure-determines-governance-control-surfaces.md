...
- [Review architecture](../reference/review-architecture.md) — evidenced-by: the shipped review subsystem realizes the substrate/context-engine governance cells in this note's worked matrix
