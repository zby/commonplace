...
- [incrementally constrained files defer centralized schema commitment until write invariants stabilize](./files-defer-centralized-schema-commitment-until-invariants-stabilize.md) — narrows one layer of the design space to substrate choice rather than treating it as the whole architecture
