---
description: "Conjecture, distinct from total effort: an addressable retained commitment may cut new target-data needs when its explanatory-reach covers a structured shift"
...
- Whether a commitment's scope can be estimated from its addressable form before any shift tests it — whether legibility supplies *evidence* about explanatory-reach, or only a handle on explanatory-reach established some other way.
...
- Whether validating a commitment's explanatory-reach against an informally specified shift is itself target-data-free, or whether it quietly consumes the same target observations the conjecture claims to save.
