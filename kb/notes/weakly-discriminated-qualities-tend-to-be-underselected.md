...
- Slayer Research Ontology v2 (unpublished lab design document, 2026-08; not yet ingested) — evidenced-by: a measurement-only acceptance design where explanation holds a schema slot but no discriminating check; the drift is predicted by construction, not yet observed
