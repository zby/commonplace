...
- [Reflective theory refinement needs interpretation, retention, and independent read-back](./reflective-theory-refinement-needs-interpretation-and-retention.md#the-functions-share-one-path-not-one-substrate) — extends: the co-indexed path a citation plus read-back serves; a citation alone is a pointer
