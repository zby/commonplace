...
- [A complete theory path does not establish improved capacity](./a-complete-theory-path-does-not-establish-improved-capacity.md#the-functions-share-one-path-not-one-substrate) — extends: the co-indexed path a citation plus read-back serves; a citation alone is a pointer
