...
- [044-User verification replaces global note status](../reference/adr/044-user-verification-replaces-global-note-status.md) — evidence: the status/lifecycle prediction played out — the fused field was deleted outright, with the per-collection redefinition of assertion force weighed and rejected in its considered alternatives
