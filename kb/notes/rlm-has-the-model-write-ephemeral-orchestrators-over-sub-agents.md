...
- [@neural_avb: Recursive Language Models — what finally gave me the 'aha' moment](https://x.com/neural_avb/status/2035040781074145412) — evidenced-by: concrete practitioner walkthrough of the REPL mechanism, symbolic variable return, and scaffold-level truncation that this note abstracts ([ingest](https://x.com/neural_avb/status/2035040781074145412))
...
- [computational-model](../tags/computational-model-README.md) — boundary case: RLM implements the full solution (symbolic orchestration over sub-agents) by having the model author it in a REPL tool
