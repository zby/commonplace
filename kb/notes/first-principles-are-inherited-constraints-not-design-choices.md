---
description: "A rule is a first principle iff it arrives in the constraint packet of a boundary commitment (consumer, substrate, domain, machinery); packets cannot be cherry-picked, so these cannot demote"
