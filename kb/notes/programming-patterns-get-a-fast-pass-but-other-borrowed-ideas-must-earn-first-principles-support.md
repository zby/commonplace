...
The KB's design draws on programming language theory, cognitive science, HCI, and empirical observation. Any source is valid — the [related-systems](../agent-memory-systems/landscape.md) reviews exist precisely to widen the input surface. What varies is the adoption gate: not all sources face the same bar.
