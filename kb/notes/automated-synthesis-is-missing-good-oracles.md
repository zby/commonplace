...
- [Geometry of Knowledge (Bystroński et al., 2025)](../sources/geometry-of-knowledge-extending-diversity-boundaries-llms.ingest.md) — evidenced-by: generators self-identify the missing low-quality/OOD detector while reporting diversity wins on NoveltyBench and AUT — unusually candid self-report of the generate-cheap-verify-expensive asymmetry
