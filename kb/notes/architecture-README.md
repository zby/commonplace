...
- [files-defer-centralized-schema-commitment-until-invariants-stabilize](./files-defer-centralized-schema-commitment-until-invariants-stabilize.md) — canonical files can defer a shared schema while meanings remain unsettled; database authority is a separate commitment made through an operative write path, not a consequence of invariant shape or unowned state
