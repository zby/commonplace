...
- [files-defer-centralized-schema-commitment-until-invariants-stabilize](./files-defer-centralized-schema-commitment-until-invariants-stabilize.md) — files keep schema commitments revisable while write invariants are unsettled; a database earns authority at write-time invariants or unowned mutable state
