...
- [Deploy-time learning is the missing middle](./retained-artifacts-enable-persistent-deployment-time-adaptation.md) — extends: promotion-on-recurrence is deploy-time learning — a durable artifact updated across sessions during use
