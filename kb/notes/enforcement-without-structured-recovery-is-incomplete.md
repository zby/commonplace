...
- [final task success does not establish intended-path health](./final-task-success-does-not-establish-intended-path-health.md) — extends: fallback strategy also needs an independent path signal; terminal success alone cannot show that the prescribed mechanism stayed healthy
