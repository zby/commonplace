...
- [apparent success is an unreliable health signal in framework-owned tool loops](./apparent-success-is-an-unreliable-health-signal-in-framework-owned.md) — extends: fallback strategy also needs observability; otherwise successful recovery erases evidence that would trigger repair
