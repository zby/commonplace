...
- [cross-representational reflection](./cross-representational-reflection.md) — synthesis: what reflective coverage means when behavior lives in prose, schemas, and code at once, and the mappings between them can silently fail
