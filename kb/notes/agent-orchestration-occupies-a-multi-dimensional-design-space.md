...
- **Prose** — human-authored or trace-derived heuristics in prompts, playbooks, notes, or skills.
...
- [Ingest: A Mini Exercise on the Mismanaged Geniuses Hypothesis (RLMs on LongCoT)](../sources/mini-exercise-mismanaged-geniuses-longcot-rlm.ingest.md) — evidence: trace-derived prompt tips occupy a prose decomposition-policy point between hand-authored heuristics and trained policy
