...
- [An instruction should fix what the executor can't determine, not what it will](./fix-what-the-executor-cant-determine-not-what-it-will.md) — extends: a second cost the frontload-or-not decision must weigh — freezing a situation-dependent value forfeits the executor's runtime advantage even when it saves context
