...
- [Machine Studying](../sources/machine-studying.ingest.md) — evidenced-by: its corpus-derived cheatsheet's gains concentrate at low inference budgets and are recovered by forced search at high budgets — the frontloading shape measured: one study pass replaces per-question rediscovery exactly where budget is scarce
