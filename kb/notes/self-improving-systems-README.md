...
- Payoff hypotheses, still open: [theory-mediated sample efficiency](./reflective-theory-refinement-needs-interpretation-and-retention.md), and [faithfulness in revision guided by rationale](./selective-revision-needs-a-faithful-rationale-not-just-a-legible-one.md).
