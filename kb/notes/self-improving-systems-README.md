...
- Payoff hypotheses, still open: [theory-mediated sample efficiency](./reflective-theory-refinement-needs-interpretation-and-retention.md), and [selective revision needing a faithful rationale](./selective-revision-needs-a-faithful-rationale-not-just-a-legible-one.md).
