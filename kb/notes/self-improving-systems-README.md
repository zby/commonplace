...
- **Improvement dynamics** — [cumulativity](./accumulation-counts-dependence-through-the-retained-result.md): dependence through the retained result itself, not through the evidence it caused; [compounding — productivity growth, not just a growing stock — needs leverage to multiply and autonomy to scale](./compounding-needs-leverage-to-multiply-and-autonomy-to-scale.md).
