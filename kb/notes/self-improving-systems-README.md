...
- [Formal systems can assess reach through causal and proof obligations](./formal-systems-can-assess-reach-through-causal-and-proof-obligations.md) — reach assessment isn't LLM-exclusive: causal inference and proof search give traditional symbolic systems a formal route to it once a claim's generality is encoded as a checkable obligation.
