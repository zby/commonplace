...
- Downstream payoff hypotheses include [improved sample efficiency under structured shifts](./semantically-revising-retained-theories-may-improve-sample-efficiency.md) and [lower oversight cost when the retained rationale is faithful](./reflection-may-lower-oversight-cost-when-its-rationale-is-faithful.md).
