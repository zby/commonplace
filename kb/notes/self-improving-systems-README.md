---
description: "Curated head for the self-improving-systems tag — membership is deliberately cheap; four independent gradings place a system, and the occupants map the axes"
...
- [Ashby's Homeostat](../sources/ashby-design-for-a-brain-ultrastability.md) — non-reflective and fully autonomous, the floor of the category: random search, a one-bit oracle, retention by equilibrium. It retains without accumulating.
...
- [Commonplace](../reference/commonplace-as-a-reflective-system.md) — reflective and human-inclusive: humans hold search and the judgment-heavy evaluation, the gates no adequate automatable oracle closes.
- A Smalltalk image alone — maximal machinery, no loop, not a member: nothing in it searches or evaluates, and the programmer supplies what is missing.
