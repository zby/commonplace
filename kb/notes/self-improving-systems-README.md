...
- Payoff hypotheses, still open: [sample efficiency from learning by theory refinement](./reflective-theory-refinement-needs-interpretation-and-retention.md), and [faithfulness in revision guided by rationale](./revision-guided-by-rationale-needs-faithfulness-not-just-legibility.md).
