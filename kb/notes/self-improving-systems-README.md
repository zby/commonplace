...
- Payoff hypotheses, still open: [sample efficiency from retained theories](./retained-theories-may-improve-sample-efficiency.md), and [faithfulness in revision guided by rationale](./revision-guided-by-rationale-needs-faithfulness-not-just-legibility.md).
