...
- [Toulmin Argument (Purdue OWL)](https://owl.purdue.edu/owl/general_writing/academic_writing/historical_perspectives_on_argumentation/toulmin_argument.html) — evidenced-by: the "warrant" concept used in the explanatory style description originates from Toulmin's argumentation model
