...
- [An open-domain theory builder becomes a software house when new domains require production-machinery changes](./unbounded-consequence-checking-makes-theory-builders-write-software.md) — extends: applies the conditional procedure demand to the producer's boundary
