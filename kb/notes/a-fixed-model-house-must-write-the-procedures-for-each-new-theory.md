...
- [Unbounded consequence-checking makes theory builders write software](./unbounded-consequence-checking-makes-theory-builders-write-software.md) — extends: derives the same procedure demand from the consequence-checking step, which no fixed set of checkers covers
