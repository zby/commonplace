...
- Raschka (2026). [Components of A Coding Agent](../sources/components-of-a-coding-agent-raschka.md) — independent practitioner convergence: "a lot of apparent 'model quality' is really context quality," with a six-component decomposition of what context quality means operationally.
...
- [Components of A Coding Agent (Raschka, 2026)](../sources/components-of-a-coding-agent-raschka.ingest.md) — grounds: independent practitioner convergence — "apparent model quality is really context quality" — with a six-component decomposition of what context quality means operationally
