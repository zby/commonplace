...
- [Ingest: Lessons from Building AI Agents for Financial Services](../sources/lessons-from-building-ai-agents-for-financial-services.ingest.md) — evidenced-by: a bounded practitioner case where model-absorbed procedural scaffolding shrank while exact fiscal-calendar normalization remained explicit
