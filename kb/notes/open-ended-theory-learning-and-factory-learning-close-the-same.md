...
- [Theory-mediated system learning combines runtime self-modeling with empirical theory refinement](./reflective-theory-refinement-has-three-separate-lineages.md) — extends: positions the same program against its runtime-reflection and theory-refinement lineages
