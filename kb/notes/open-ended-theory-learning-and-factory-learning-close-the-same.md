...
Iteration, where the result of criticism shapes the next round, is a
...
patching satisfies that letter: a failing case yields a rule, the rule is retained, later runs load
...
- [Theory building has distinct epistemic, structural, and implementation precedents](./theory-building-has-distinct-precedents.md) — extends: distinguishes the program's epistemic, structural, and implementation precedents
