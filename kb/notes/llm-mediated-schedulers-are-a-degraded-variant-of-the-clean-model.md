...
The framework-design consequence of this diagnosis is developed in [tool loop](./tool-loop-README.md): if conversation-mediated scheduling is the degraded case, strong frameworks should expose control surfaces that let the application layer move the loop out of chat.
