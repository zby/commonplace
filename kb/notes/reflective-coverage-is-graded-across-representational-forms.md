...
- [Commonplace as a reflective system](../reference/commonplace-as-a-reflective-system.md) — evidence: a system graded across forms — modification-grade coverage of natural-language and symbolic artifacts, selection-grade control over the parametric form
