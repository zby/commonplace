---
description: "Reflective coverage is graded per representational form and operation profile; selection among opaque components — pinning a model — is real but selection-only coverage of the parametric form"
...
- [Commonplace as a reflective system](../reference/commonplace-as-a-reflective-system.md) — evidence: a system graded across forms — modification-grade coverage of prose and symbolic artifacts, selection-grade control over the parametric form
- [A self-improving system needs a profile, not a ladder](./a-self-improving-system-needs-a-profile-not-a-ladder.md) — extends: locates form breadth and the operation profile within the wider pathway profile
