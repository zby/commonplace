...
- [Knowledge-Centric Self-Improvement ingest](../sources/knowledge-centric-self-improvement-2607.19592.ingest.md) — evidenced-by: a measured system instantiating all three mechanisms in the knowledge-curation dimension, whose verification-gated shared store sits outside the note's distinguishing predictions
