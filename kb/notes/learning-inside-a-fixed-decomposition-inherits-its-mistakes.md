...
- [Ingest: Co-Harness: Co-Evolving Harnesses and Model Weights for LLM Agents](../sources/co-harness-co-evolving-harness-and-model-weights.ingest.md) — evidenced-by: in a two-round Qwen tool-integrated mathematical-reasoning experiment, alternates validated changes to prompts, tool schemas, skills, middleware, and memory with model fine-tuning; treating that as a broader effective update space is this note's transfer
