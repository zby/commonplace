...
- [Kephart & Chess, The Vision of Autonomic Computing](../sources/the-vision-of-autonomic-computing.md) — evidenced-by: MAPE-K's origin document, a vision essay with no membership test, corroborating the reference-model reading inherited through Weyns
