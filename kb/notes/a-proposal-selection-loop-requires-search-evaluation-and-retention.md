...
The Homeostat's contrast with a gated system is architectural, not merely a difference of gate strength. It stands on the excluded side of the boundary just drawn. [Gödel machines](./goedel-machines-are-a-proof-governed-case-of-self-modification.md) sit inside the subtype at its formal extreme, a proof-mediated gate rather than none at all; that architecture is developed in their own note.
...
The proposal-selection decomposition is offered as a conceptual model of one architecture, with the [category membership question](./definitions/self-improving-system.md) settled elsewhere. It does not claim to define every form of adaptation or self-improvement.
...
- [Ashby, Design for a Brain — ultrastability](../sources/ashby-design-for-a-brain-ultrastability.md) — evidenced-by: a local source review supporting the contrast case; direct primary-source grounding remains a literature handoff
