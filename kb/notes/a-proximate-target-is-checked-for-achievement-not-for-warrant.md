...
- [Revision guided by rationale needs faithfulness, not just legibility](./selective-revision-needs-a-faithful-rationale-not-just-a-legible-one.md) — extends: what stating a linking claim has to achieve, and why legibility alone leaves the repair confidently wrong
