...
- [Professional developers don't vibe — they control](../sources/professional-software-developers-dont-vibe-they-control.ingest.md) — empirical evidence that developers naturally practice the stabilisation loop
