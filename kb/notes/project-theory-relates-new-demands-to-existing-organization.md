...
- [An addressable theory can coordinate heterogeneous factory development](./addressable-theory-can-coordinate-heterogeneous-factory-development.md) — mechanism: supplies the explicit natural-language surface proposed to coordinate changes across machinery
