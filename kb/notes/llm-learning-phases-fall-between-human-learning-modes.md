...
- [deploy-time learning: the missing middle](./retained-artifacts-enable-persistent-deployment-time-adaptation.md) — extends: adds deploy-time as a fourth phase that also falls between human modes; the three-timescale framework is the KB's version of the spectrum Amodei describes
