...
- [Knowledge-Centric Self-Improvement ingest](../sources/knowledge-centric-self-improvement-2607.19592.ingest.md) — evidence: a first external classification — a natural-language-only improvement loop whose gains sit inside fixed, externally supplied symbolic verification
