...
David Deutsch's [*The Beginning of Infinity*](https://en.wikipedia.org/wiki/The_Beginning_of_Infinity) argues that the mark of good knowledge is **reach** — explanations that apply in contexts they were never designed for, because the explanation captures structure that isn't context-dependent. A gene "knows" how to build an eye but can't help you design a telescope. Newton's optics does both. We'll call the low-reach end **adaptive** (patterns that work but don't explain why) and the high-reach end **explanatory** (accounts that capture causal structure); reach is what distinguishes them.
