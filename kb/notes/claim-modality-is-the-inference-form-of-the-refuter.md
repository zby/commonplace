...
- [domain pricing routes an exception to idealization assessment but does not decide it](./domain-pricing-routes-an-exception-to-idealization-assessment.md) — grounds: the two-stage comparative structure that makes the ideal-type refuter operational
- [title as claim exposes commitments, enabling Popperian maintenance](./title-as-claim-exposes-commitments-enabling-popperian-maintenance.md) — grounds: the maintenance frame in which refuters are the exposed commitment surface
- [narrowing bought to survive review is paid for in content](./narrowing-bought-to-survive-review-is-paid-for-in-content.md) — grounds: the refuter guard whose load-bearing role the zero-exposure prediction explains
- [candidacy evidence licenses escalation to assessment, not acceptance](./candidacy-evidence-licenses-escalation-not-acceptance.md) — extends: the routing stage's Peircean evidential role developed on its own
- [066-Claims declare modality in text, and passes repair mode mismatch](../reference/adr/066-claims-declare-modality-in-text-and-passes-repair-mode-mismatch.md) — evidenced-by: the shipped refuter-defined mode system this mapping organizes
