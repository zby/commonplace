...
- [theory refinement may improve sample efficiency under structured shifts](./learning-by-theory-refinement-may-improve-sample-efficiency.md) — conjecture: the measurable payoff of a discovered theory is fewer target observations after a shift that preserves the structure it names, conditional on reach-assessment having earned it
