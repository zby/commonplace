...
- [A domain-priced exception does not refute an idealization](./a-domain-priced-exception-does-not-refute-an-idealization.md) — grounds: supplies the pricing criterion under which the immutable-class model survives its reflective counterexamples as a declared idealization
