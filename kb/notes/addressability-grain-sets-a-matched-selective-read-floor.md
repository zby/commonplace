...
- [Pointer design tradeoffs in progressive disclosure](./pointer-design-tradeoffs-in-progressive-disclosure.md) — extends: its tier table compares pointers by specificity, cost, availability, and accuracy; grain adds the retrieval-floor test against the tier below it
