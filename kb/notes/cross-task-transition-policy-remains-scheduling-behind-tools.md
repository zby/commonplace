...
- [Claude Code dynamic workflows](../agentic-systems/claude-code-dynamic-workflows.md) — evidenced-by: its model-authored JavaScript visibly selects sub-agent transitions even though the harness exposes workflow invocation through a callable interface
