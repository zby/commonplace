...
- [agent-capability-is-bottlenecked-by-selection-over-bounded-context](./agent-capability-is-bottlenecked-by-selection-over-bounded-context.md) — formalises agent orchestration as the select/execute/absorb loop over bounded context, with the selection function as the central optimisation problem
