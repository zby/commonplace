...
- [computational-model](../tags/computational-model-README.md) — extends: develops the model's main architectural implication for implementations
...
- [Distinct residue classes require distinct functions in a self-improving architecture](./residue-classes-need-different-mechanisms-so-architecture-is-mixed.md) — contrasts: motivates the scheduler/model split from warrant classes instead of from context scarcity
