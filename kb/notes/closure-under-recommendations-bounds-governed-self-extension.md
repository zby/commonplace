...
- [Cross-representational reflection](./cross-representational-reflection.md) — extends: the representational-form axis widens to the mappings between forms when a recommendation spans them
