...
- [programming practices apply to prompting](./programming-practices-apply-to-prompting.md) — explains why a DSL and explicit state protocols help before crystallisation
- [crystallisation](./crystallisation.md) — contrasts: OpenProse stabilises orchestration practice but does not crystallise the runtime semantics
