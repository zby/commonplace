...
- [computational-model](../tags/computational-model-README.md) — exemplifies: programming-language concepts reaching into KB design is an explanatory-reach bet under audit
