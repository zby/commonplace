...
- [Local materialization should outperform distant natural-language declarations](./local-materialization-should-outperform-distant-declarations.md) — contrasts: tests a local-view remedy for under-reach, while this note requires write-time scoping to prevent cross-artifact sense collision
