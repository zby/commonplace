...
- [Ingest: The Self-Healing Agent Harness](../sources/the-self-healing-agent-harness-2048912026018484317.ingest.md) — see-also: grades final responses rather than trajectories, then routes low scores into separate root-cause investigation; it does not test successful fallbacks
