...
- [instructions are skills without automatic routing](../instructions-are-skills-without-automatic-routing.md) — parallels: OpenSage's SKILL.md system is an independent convergence on filesystem-discovered, metadata-described callable procedures
