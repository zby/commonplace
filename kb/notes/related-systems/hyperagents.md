...
- [automating-kb-learning-is-an-open-problem](../automating-kb-learning-is-an-open-problem.md) — contrasts: HyperAgents benefits from hard benchmark oracles, while KB mutation still stalls on judgment-heavy operations
