...
- [Distillation](../definitions/distillation.md) — extends: summary, manifest, abstract, and stub generation are genuine derived-context artifacts layered over the canonical files
