...
- [Distillation](../definitions/distillation.md) — contrasts: Napkin's auto-distill captures and routes structured notes, but does not yet provide the stronger synthesis and task-specific compression this note argues for
