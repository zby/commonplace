...
- [deploy-time learning](../deploy-time-learning-is-the-missing-middle.md) — sharpens: this system sits squarely in the deploy-time artifact-update space, using persistent prompt-state rather than weights
