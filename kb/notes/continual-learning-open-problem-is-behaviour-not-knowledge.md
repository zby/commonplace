...
- [Trace-learning techniques in related systems](../agent-memory-systems/trace-learning-techniques-in-related-systems.md) — grounds: surveyed systems already split into weight-promotion and artifact-promotion loops
