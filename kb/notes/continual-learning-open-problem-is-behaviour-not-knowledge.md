...
- [Axes of substrate analysis](./axes-of-substrate-analysis.md) — foundation: defines the four axes (class, backend, form, role); this note applies the role axis to argue which half of continual learning is open
- [treat continual learning as substrate coevolution](./treat-continual-learning-as-substrate-coevolution.md) — extends: asks how the three substrate classes' improvement loops should relate
