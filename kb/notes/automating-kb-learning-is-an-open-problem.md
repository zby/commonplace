...
- [session-mining techniques in related systems](./session-mining-techniques-in-related-systems.md) — sharpens: the extraction side of the loop is now concrete in source code (Napkin, Pi Self-Learning, OpenViking); what remains open is evaluation of whether mined candidates deserve durable KB status
