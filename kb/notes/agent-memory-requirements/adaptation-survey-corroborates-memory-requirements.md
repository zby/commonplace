...
| Skill library | Distilled procedural memory, often [system-definition artifact](../definitions/system-definition-artifact.md) use | The article emphasizes acquisition mechanism; our notes also ask about invocation, routing, execution policy, provenance, and lifecycle. |
