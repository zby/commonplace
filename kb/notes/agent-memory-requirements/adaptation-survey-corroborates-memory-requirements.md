...
But the survey is insufficient as a memory-system design guide because it classifies by optimization locus and signal source, not by the decision criteria that make a memory usable. It does not preserve the design note's [artifact-analysis fields](../axes-of-artifact-analysis.md): storage substrate, representational form, lineage, and behavioral authority. A durable learned result can live in weights, a vector index, a prose rule, a source review, a skill file, a validator, a generated cue, or an external work surface. Those artifacts differ in inspectability, authority, rollback, verification, activation, and lifecycle cost. A T2 label does not tell an operator who may trust, edit, promote, retire, regenerate, or override the memory.
