...
- [Large Language Model Agents are not Always Faithful Self-Evolvers](https://arxiv.org/html/2601.22436v3) - evidence: shows why written memory must be evaluated for behavioral influence rather than assumed effective
