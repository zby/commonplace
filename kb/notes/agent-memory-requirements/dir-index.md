...
- [Keep Memory Roles And Compiled Views From Drifting](./keep-compiled-views-aligned.md) *(note)* - Generated cues, prompt files, indexes, and assistant-specific views need source-of-truth rules so they do not drift into authority
