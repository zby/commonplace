...
- [Theory building and capacity building make the same kind of fallible commitment](./theory-and-capacity-building-make-the-same-kind-of-commitment.md) — grounds: separates the explanatory commitment from the constructive choices that change the object
- [Project-theory possession requires comparing new demands with existing organization](./project-theory-relates-new-demands-to-existing-organization.md) — extends: develops the programming case as a test of coherent modification rather than one successful change
