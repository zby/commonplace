...
| `evidenced-by` | asym | notes, types, reference, agent-memory, agentic-systems, sources, external sources | the target observation, case, or source corroborates, qualifies, or bounds this assertion |
