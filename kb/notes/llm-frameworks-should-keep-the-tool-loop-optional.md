...
- [Claude Code dynamic workflows](../agentic-systems/claude-code-dynamic-workflows.md) — evidenced-by: shipped partial instance of the requested layering — a returning `agent()` beneath the frozen loop — qualified on audience, substrate, and granularity
