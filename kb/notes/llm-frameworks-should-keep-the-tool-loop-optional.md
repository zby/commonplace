...
- [Claude Code dynamic workflows](../agentic-systems/claude-code-dynamic-workflows.md) — evidence: shipped partial instance of the requested layering — a returning `agent()` beneath the frozen loop — qualified on audience, substrate, and granularity
