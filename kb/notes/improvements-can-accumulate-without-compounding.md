...
- [Commonplace as a reflective system](../reference/commonplace-as-a-reflective-system.md) — evidenced-by: analyzes Commonplace, the human-inclusive repository system, and supplies candidate episodes whose contribution to compounding remains to be measured
