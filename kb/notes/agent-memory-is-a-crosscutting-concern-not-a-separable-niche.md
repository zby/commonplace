...
- [Designing a Memory System for LLM-Based Agents](./designing-agent-memory-systems.md) — exemplifies: gives a full design example of memory as storage, activation, and learning machinery distributed across the system rather than one pluggable subsystem
