...
- [stale-indexes-reduce-discovery-when-they-suppress-fallback-search](./indexes-lower-recall-when-they-suppress-retrieval-that-would-find-more.md) — apparent completeness can suppress a broader fallback and lower recall along that route (now in [maintenance](./kb-maintenance-README.md))
