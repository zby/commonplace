...
- [Five reported self-improvement paths expose bounded redesign surfaces within supplied methods](./five-reported-self-improvement-paths-expose-bounded-redesign-surfaces.md) — evidenced-by: owns the detailed causal-path and supplied-machinery reading for the five-system cohort
