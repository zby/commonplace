...
- [Stale indexes reduce discovery when they suppress fallback search](../indexes-lower-recall-when-they-suppress-retrieval-that-would-find-more.md) — rests-on: the retained claim the strain was read through
