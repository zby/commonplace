...
The target was the 1,991-word version of [Reflective self-improvement](../../articles/reflective-self-improvement.md) at commit `7e21c9ae`, immediately before the first explicit simplification commit. Three fresh sub-agents received that exact baseline. Each saw only its assigned instruction and wrote a separate candidate; none saw the live article or another candidate.
