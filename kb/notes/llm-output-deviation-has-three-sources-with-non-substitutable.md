...
- [Ma et al. — Prompt Stability in Code LLMs](../sources/prompt-stability-code-llms-emotion-personality-variations.ingest.md) — evidenced-by: separates all three sources methodologically; the performance-stability decoupling is the evidence they are not one phenomenon
