...
- [deploy-time-learning](./retained-artifacts-enable-persistent-deployment-time-adaptation.md) — the three timescales framework; graduation from operational to knowledge space is a form of codification
