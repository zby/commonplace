...
- [Retained system-definition artifacts enable persistent deployment-time adaptation](./retained-artifacts-enable-persistent-deployment-time-adaptation.md) — the persistent adaptation path retained artifacts provide; graduation from operational to knowledge space is a form of codification
