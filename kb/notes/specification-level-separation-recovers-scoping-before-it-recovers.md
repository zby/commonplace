...
- [programming practices apply to prompting](./underspecification-and-indeterminism-complicate-programming-for.md) — explains why a DSL and explicit state protocols help before codification
