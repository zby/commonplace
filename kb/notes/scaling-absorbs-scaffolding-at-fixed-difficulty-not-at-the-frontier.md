...
- [The bitter lesson selects against unearned reach, not against structure](./bitter-lesson-selects-against-unearned-reach-not-against-structure.md) — contrasts: supplies the selection criterion, asserted versus earned scope, for claims; it does not establish scaffolding absorption or the fixed-difficulty/frontier distinction argued here, which concern carriers
