...
## Deutsch's explanatory-reach test varies the explanation, not the prompt

The [explanatory-reach note](./first-principles-reasoning-selects-for-explanatory-reach-over.md) uses "can you vary it?" in a different sense. Deutsch's test asks: Can you change a premise in the explanation? Can you predict what changes in the conclusion? Does that reveal causal structure that transfers beyond the original case?
...
- An explanatory-reach test could be reduced to paraphrase robustness, when the point is to vary the mechanism and predict the consequences.
...
- vary the **explanation** → learn whether the idea has mechanistic explanatory-reach
