...
- [effective context is task-relative](./effective-context-is-task-relative-and-complexity-relative-not-a.md) — grounds: reconciliation complexity reduces effective context, so the feasibility boundary depends on the task, not just fragment count
