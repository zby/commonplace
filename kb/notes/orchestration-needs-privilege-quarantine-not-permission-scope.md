...
- [GBrain](../agentic-systems/reviews/gbrain.md) — evidenced-by: independently reaches the same read/act privilege split, with the host agent itself classified untrusted at the API boundary
