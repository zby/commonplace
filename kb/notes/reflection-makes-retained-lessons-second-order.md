...
- [Theory-mediated self-improvement needs interpretation, retention, and independent read-back](./theory-mediated-self-improvement-needs-interpretation-and-retention.md) — extends: stakes the statistical payoff this note supplies the mechanism for, and names the retained-path functions it depends on
