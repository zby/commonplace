...
- [distillation](./distillation.md) — mapped, loosely: legal commentary extracts principles from case law without changing medium; legal briefs are the tighter analogue for task-targeted compression
