...
- [006-two-tree-installation-layout](../reference/adr/006-two-tree-installation-layout.md) — enables: the installation step that generates the control-plane fragment
