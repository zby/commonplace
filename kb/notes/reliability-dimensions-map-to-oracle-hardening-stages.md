...
- [deploy-time-learning](./retained-artifacts-enable-persistent-deployment-time-adaptation.md) — reliability hardening as deploy-time learning, not training-time learning
