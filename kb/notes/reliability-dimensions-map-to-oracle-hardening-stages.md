...
- [three distinct mechanisms](./agentic-systems-learn-through-three-distinct-mechanisms.md) — reliability hardening as deploy-time learning, not training-time learning
