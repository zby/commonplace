...
- [Ingest: Meta-Harness: End-to-End Optimization of Model Harnesses](../sources/meta-harness-end-to-end-optimization-of-model-harnesses.ingest.md) — evidenced-by: retained ablation extracts supply the three accuracy figures and the source's comparison between trace access and summaries
