...
- [codification: the missing middle](./retained-artifacts-enable-persistent-deployment-time-adaptation.md) — context: the three timescales framing; agent statelessness reframes in-context as "loading" not "learning"
