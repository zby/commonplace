...
- [codification: the missing middle](./deploy-time-learning-the-missing-middle.md) — context: the three timescales framing; agent statelessness reframes in-context as "loading" not "learning"
