...
- [design methodology — borrow widely, filter by first principles](./programming-patterns-get-a-fast-pass-but-other-borrowed-ideas-must.md) — foundation: the adoption filter this note motivates; that note says *how* to filter, this note says *why* filtering is necessary
...
- [codification: the missing middle](./deploy-time-learning-is-the-missing-middle.md) — context: the three timescales framing; agent statelessness reframes in-context as "loading" not "learning"
