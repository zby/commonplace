...
- [ADR 011 — notes must be accessible to external readers](./adr/011-notes-must-be-accessible-to-external-readers.md) — extends: GitHub Pages introduced a third audience (external readers with no KB context), requiring inline glosses for KB vocabulary
