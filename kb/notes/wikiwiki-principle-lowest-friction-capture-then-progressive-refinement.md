...
2. **Our type ladder mirrors this.** The [document classification](../reference/type-system.md) hierarchy follows the same pattern:
...
- [document-classification](../reference/type-system.md) — the type ladder this principle animates: text → note → structured-claim
