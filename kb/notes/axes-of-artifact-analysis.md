...
- [LLM context is a homoiconic medium](./llm-context-is-a-homoiconic-medium.md) - mechanism: lets the same natural-language content function as a knowledge artifact or system-definition artifact depending on authority path
...
- [treat continual learning as substrate coevolution](./treat-continual-learning-as-substrate-coevolution.md) - extends: builds on the natural-language/symbolic/distributed-parametric split to ask how improvement loops should relate
