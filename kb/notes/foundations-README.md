...
- [a universal knowledge framework demotes content taxonomies to defaults](./a-universal-knowledge-framework-demotes-content-taxonomies-to-defaults.md) — content taxonomies demote to guarded defaults; what stays fixed is stipulated (answerability) or enforced (contract declaration), not certified universal; contradicts the tripartition's exhaustiveness claim
