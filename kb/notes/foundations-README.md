...
- [charting-the-knowledge-access-problem-beyond-rag](./knowledge-access-architecture-must-be-evaluated-end-to-end.md) — exploratory decomposition: separates substrate, pointers, navigation modes, synthesis, and maintenance so RAG-vs-filesystem debates stop collapsing unlike tasks
