...
- [artifact classification separates profile, content kind, lineage, and authority](./a-knowledge-base-holds-theories-descriptions-and-prescriptions-with.md) — four non-substitutable questions keep communicative profile separate from region-level belief or residual choice, production lineage, and path-relative force
