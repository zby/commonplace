...
- [provenance warrants a decomposition's scope claim; only discriminating use earns it](./provenance-warrants-a-decompositions-scope-claim-use-earns-it.md) — three provenances grade a carve's warrant — conditional, transferred, pragmatic — while earning stays with use that could have broken the claim
