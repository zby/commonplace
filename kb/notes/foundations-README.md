...
- [actionable theories and reflexive system construction](./actionable-theories-and-reflexive-system-construction.md) — synthesis: when LLM-executable methodology becomes system machinery, when that machinery becomes reflexive, and where Gödel-machine analogies stop
