...
- [Deploy-time learning is the missing middle](./retained-artifacts-enable-persistent-deployment-time-adaptation.md) — frames the timescale at which these placements adapt
