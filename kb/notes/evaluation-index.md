...
- [Knowledge storage does not imply contextual activation](./knowledge-storage-does-not-imply-contextual-activation.md) - Separates knowledge that exists, knowledge loaded into context, and knowledge that actually changes behavior; explains why retrieval and long context do not guarantee activation
