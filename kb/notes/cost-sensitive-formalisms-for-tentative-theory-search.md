...
- [Theory refinement may improve sample efficiency under structured shifts](./learning-by-theory-refinement-may-improve-sample-efficiency.md) — extends: supplies the possible gain and broad-wrong-theory cost that a budgeted model could measure
