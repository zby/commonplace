...
- [Learning by learning by theory refinement may improve sample efficiency under structured shifts](./learning-by-theory-refinement-may-improve-sample-efficiency.md) — extends: the pathway this note clears of the objection, and the acceptance test it makes conditional
