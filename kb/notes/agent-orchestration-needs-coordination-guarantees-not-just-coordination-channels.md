...
- [Tracecraft](./related-systems/tracecraft.md) — exemplifies: provides all five coordination channels but guarantees for almost none; non-atomic task claiming is a textbook case of the channel/guarantee gap
