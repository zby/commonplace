...
- [programming practices apply to prompting](./underspecification-and-indeterminism-make-programming-practices-harder-in-distinct-ways-when-applied-to-prompting.md) — context: the structuring disciplines (typing, testing, compilation) that programming practices bring are especially needed in a homoiconic medium that provides no built-in structure
