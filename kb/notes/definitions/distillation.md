...
- [evolving understanding needs re-distillation not composition](../evolving-understanding-needs-holistic-rewrite-not-composition.md) — exemplifies: when a consumer needs the whole evolving picture, holistic rewrite is re-distillation
