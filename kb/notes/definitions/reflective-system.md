...
- [An improvement loop requires search, evaluation, and operative retention](../an-improvement-loop-requires-search-evaluation-and-operative-retention.md) — extends: reflection supplies one causal path into the loop, but not the search, evaluation, or operative retention the loop needs
