...
- **Observer access is an evidence question.** A model may formulate and
  ...
  [evidence discussion](../commonplace-studies-conjectural-learning-through-retained-theories.md#evidence)
...
- **The subject and the machinery are unrestricted.** The theory may describe
  ...
  [reflective system](./reflective-system.md). A
  ...
  theories is a [theory builder](./theory-builder.md);
...
- **Proof-only revision under an uncriticized theory.** A formulated theory
  ...
  [Gödel machine](../goedel-machines-are-a-proof-governed-case-of-self-modification.md);
