...
- [A method's ceiling bounds the method, not the transfer it already made](./a-method-ceiling-bounds-the-method-not-the-transfer-already-made.md) — extends: reliability, speed, and cost gains inside a fixed automation envelope transfer no responsibility away from people
