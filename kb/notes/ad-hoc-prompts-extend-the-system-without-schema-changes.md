...
- [programming-practices-apply-to-prompting](./underspecification-and-indeterminism-complicate-programming-for.md) — extends: this note adds a practice that goes the other direction — sometimes staying at the prompt level is the right choice, not a failure to compile
...
- [skills derive from methodology](./skills-derive-from-methodology-through-distillation.md) — enables: skill extraction keeps the procedure while factoring out the discursive reasoning that produced it
