...
- [skills derive from methodology](./skills-derive-from-methodology.md) — enables: skill extraction keeps the procedure while factoring out the discursive reasoning that produced it
