...
- [Conjecture is seeing the particular as an instance of the general](./conjecture-is-seeing-the-particular-as-an-instance-of-the-general.md) — **extends**: the consolidation heuristic ("clusters of similar low-reach notes suggest an unextracted principle") is the discovery operation reframed as a maintenance signal.
