...
- [scheduler-LLM separation exploits an error-correction asymmetry](./scheduler-llm-separation-exploits-an-error-correction-asymmetry.md) — extends: Tu's two-channel model provides an alternative decomposition; this source could support promoting the note from speculative
