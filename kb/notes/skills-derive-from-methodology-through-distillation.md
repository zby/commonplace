...
- [claim notes should use Toulmin-derived sections](./claim-notes-should-use-toulmin-derived-sections-for-structured.md) — example source: Toulmin structure is distilled into the skill's articulation test
