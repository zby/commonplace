...
- [raw accumulation does not create usable memory](./raw-accumulation-does-not-create-usable-memory.md) — motivates: ingress controls need semantic review because structural validity does not prove content quality
