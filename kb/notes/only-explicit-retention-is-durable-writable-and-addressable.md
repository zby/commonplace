...
- [Deploy-time learning is the missing middle](./retained-artifacts-enable-persistent-deployment-time-adaptation.md) — extends: adds the addressability property and the human row to its three-timescale media comparison
