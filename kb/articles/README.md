...
- [A research program for learning software factories](./a-research-program-for-learning-software-factories.md) — whether an agentic software-production system can learn reusable family-specific production machinery from experience; theory mediation as one candidate mechanism; coherent modification under delayed feedback as its first controlled test; the evidence levels; the current human-assisted loop; and the evidence still needed.
