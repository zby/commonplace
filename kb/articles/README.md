...
- [How existing self-improving systems relate to conjectural learning](./nearest-existing-constructions-to-a-witness-house.md) — compares eighteen systems, starting with reported tests of retained knowledge and skill improvement. Separates evidence of learning, formulated criticism, autonomy, transfer, and retention efficiency; identifies human-assisted bootstraps and automated revision mechanisms, then proposes comparisons that isolate their contributions.
