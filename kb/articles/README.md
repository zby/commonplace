...
- [A research program for learning software factories](./a-research-program-for-learning-software-factories.md) — whether production experience can cause retained changes to a software factory's reusable machinery that later work depends on, and whether a later factory state can then be shown better than its predecessor without training a new model; held project theory as the functional hypothesis for coherent modification; retained natural-language theory as the tested realization; and staged holding, acquisition, and successor-factory experiments.
