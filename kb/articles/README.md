...
- [A research program for learning software factories](./the-reachability-conjecture-train-the-house-not-the-llm.md) — whether a software factory can learn from its production experience — retained machinery changes that make a later factory state better than its predecessor — without training a new model; held project theory as the functional hypothesis for coherent modification; retained natural-language theory as the tested realization; and staged holding, acquisition, and successor-factory experiments.
