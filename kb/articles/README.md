...
- [A research program for learning software factories](./a-research-program-for-learning-software-factories.md) — the program statement: the central question of whether a system that revises retained project theory can keep its own program modification coherent across search, backtracking, recovery, and delayed feedback; the four evidence levels; the difference between a claim's truth and its fit; the current human-assisted loop; and the evidence still needed to change the program's status.
