...
The program's target is not learning alone but learning that leaves the factory better, and the occurrence condition does not by itself establish improvement. The program's instrument is a measurement laid over snapshots of the process:
...
Even full success here is bounded: one passing successor establishes one learning-and-improvement transition, not indefinite compounding, recursive self-improvement, or computational closure.
