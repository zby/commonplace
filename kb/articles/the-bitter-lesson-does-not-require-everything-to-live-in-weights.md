...
The [production-method versus representational-form analysis](../notes/the-bitter-lesson-selects-production-methods-not-representational.md) develops the full argument and its empirical burden. [*Continual learning outside the weights*](./continual-learning-outside-the-weights.md) takes up Sutton's later, stronger position that a deployed agent must keep updating its weights.
