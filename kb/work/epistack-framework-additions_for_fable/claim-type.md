...
Framework boundary: [ADR 044](../../reference/adr/044-user-verification-replaces-global-note-status.md) removes base-note status entirely. Any casebook claim state must therefore be coherent type-local metadata or a recomputable mark, not a reinterpretation of a global lifecycle field.
