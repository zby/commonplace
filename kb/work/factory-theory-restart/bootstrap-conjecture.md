...
into notes and harness. Progress has a measure: how often the people must
supply the theory function — name the relevant note, choose the decisive
branch, catch the misfit the harness missed. The bootstrap is working when
those interventions decline while coherence holds; it has stalled when each
new demand class needs the human holder as much as the last — which is
containment again, permanently.

**What would refute it.** Two failure modes. Interventions that never
decline: internalization is not happening, and the triple is decoration on
