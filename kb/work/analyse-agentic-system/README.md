...
The operator commissioned the downstream
[consumer migration workshop](../agentic-analysis-consumer-migration/README.md)
on 2026-09-05. It owns moving legacy-review dependencies one by one to files
generated by the main review and retiring mandatory duplicate legacy
publication. The construction and trial history remains here; the earlier
legacy-publication arrangement below describes the migration's starting state.
