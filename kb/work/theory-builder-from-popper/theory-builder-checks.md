...
2 consumption, 3 criticism, 4 retention, 5 addressability. Unless a case says
...
| 17 | A system meets all five conditions, and its criticism and revisions never improve later work | Inside; learning is not established | Test 1: improvement is not a condition. This is the case the program's experiments must be able to find |
