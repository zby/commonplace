...
- **Source snapshot retirement.** `kb/sources/` has no exit for a wrong or dead capture. Predicted to archive under the corrected test below, and the cheapest second worked case available.
