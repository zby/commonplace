...
6. **Inductive-bias connection.** Extrapolation needs bias; hyperpolation needs priors over functional forms (Ord's Bayesian reading — and his cited Lucas et al. "superspace extrapolation" experiments are literally inductive-bias measurements). The methodology-as-inductive-bias thread's claim (absorbed 2026-07-17 into the [structure note](../../notes/theory-and-methodology-form-a-two-layer-execution-system.md)'s open questions) — promotion is the system acquiring its own bias — extends: *what* is acquired is a prior that makes tomorrow's extrapolations cheap.
...
- [theory and methodology form a two-layer execution system](../../notes/theory-and-methodology-form-a-two-layer-execution-system.md) — extends: promotion acquires the prior that cheapens future extrapolation (the absorbed inductive-bias framing)
