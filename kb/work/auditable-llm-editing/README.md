...
- [Semantic review catches content errors that structural validation cannot](../../notes/semantic-review-catches-content-errors-that-structural-validation-cannot.md) — background: semantic checks need structured rubrics but remain judgment-dependent.
- [Selector-loaded review gates could let review-revise learn from accepted edits](../../notes/selector-loaded-review-gates-could-let-review-revise-learn-from-accepted-edits.md) — possible maturation path for recurring editing failures.
...
- [Human writing structures transfer to LLMs because failure modes overlap](../../notes/human-writing-structures-transfer-to-llms-because-failure-modes-overlap.md) — rationale for testing specific writing structures against specific LLM failure modes.
