# Agent prompt — cleanup cohort 07
...
**Scope:** 4 targets, 9 ingests, 0.53 MB of snapshot. Four targets over nine ingests — the most sources per target, so the best test of whether one agent's context holds across a wide cohort.

---

Work cleanup cohort 07 in the Commonplace repository at
`/home/zby/llm/commonplace`.

Read `kb/work/literature-disposition/cleanup-cohort-07.md` for your frozen
