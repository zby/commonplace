...
Thirteen candidates now have final dated artifact dispositions. The Gödel-machine,
...
checked membership contract. The index-completeness note was kept as the
...
first-time-human note was rewritten as a conditional access-path comparison and
kept as the one-authority/per-consumer-interface premise used by two ADRs. The
addressability-grain note was kept as a matched-unit floor after its measured
case was pinned and its unmeasured helping case made conditional. The
human–LLM-differences candidate was then removed from the settled cohort as a
category error, leaving its artifact unchanged. All fourteen candidates are
therefore resolved: thirteen dispositions and one cohort correction. The
...
index-completeness note was kept after its independent citation boundary was
re-tested. The comparisons and current
...
[remaining-dispositions.md](./remaining-dispositions.md). No artifact
judgment remains. The
...
[The dated disposition](./remaining-dispositions.md#ninth-dated-artifact-disposition--index-completeness-and-editorial-orientation)
keeps the note as an independent analytic premise. The repaired MOC note imports
the distinction, while ADRs 025 and 026 apply it to different shipped choices;
none can recover the general claim without reversing that dependency. The
execution removed only an obsolete five-note curation heuristic and its stale
`COLLECTION.md` quotation.

## Tenth disposition — retrieval suppression by exhaustive views

[The dated disposition](./remaining-dispositions.md#tenth-dated-artifact-disposition--retrieval-suppression-by-exhaustive-views)
keeps the note as an independent conditional control-flow premise. Its live
claim fixes both retrieval routes and does not predict how often consumers stop
or whether fallback retrieval usually wins. Derived-copy policy, reflective
...
## Twelfth disposition — first-time-human access heuristic

[The dated disposition](./remaining-dispositions.md#twelfth-dated-artifact-disposition--first-time-human-access-heuristic)
rewrites and keeps the note as a path-relative access comparison. The broader
human–LLM note owns the convention-transfer filter; this note owns the selected
slice versus whole-artifact boundary and the response of exposing different
interfaces over one authority. Two ADRs and several documentation notes consume
that premise directly, while the deferred single-source-publishing tradition is
only an analogue.

## Thirteenth disposition — addressability grain

[The dated disposition](./remaining-dispositions.md#thirteenth-dated-artifact-disposition--addressability-grain)
keeps the note as an independent matched-unit comparison. Sufficiency,
resolution-switching, and the total recompute ledger each consume or bound this
narrower floor rather than recovering it. The execution pins the measured
historical case to commit `3c25fc66` and stops presenting the unmeasured
description path as a benchmark. Database and passage-retrieval traditions
remain prior analogues, not authority for the live conditional.

## Fourteenth candidate resolution — human–LLM differences

[The dated resolution](./remaining-dispositions.md#fourteenth-candidate-resolution--humanllm-differences)
removes the candidate from the settled cohort without changing its artifact.
Its central contribution is a convention-transfer and dual-audience method that
the claim inventory placed in no outside tradition; the one
navigation-adjacent access row already has its own normalized note. Fourteen
inbound artifacts make clear why cohort removal is not artifact retirement. No
keep, merge, thin, or retire claim was made.
...
- [Source-backed target dispositions](./source-backed-dispositions.md) — dated
  ...
  enforced tag-README
- [Remaining artifact dispositions](./remaining-dispositions.md) — dated
  post-MOC judgments, beginning with the independent
  membership/orientation premise
