...
Invoke [Analyse agent memory](../../../../../../instructions/analyse-agent-memory/SKILL.md) in a fresh
...
Invoke
[`analyse-external-system-epistemic-architecture.md`](../../../../../../instructions/analyse-external-system-epistemic-architecture.md)
...
[`scan-agentic-system-transfer`](../../../../../../instructions/scan-agentic-system-transfer/SKILL.md) only
...
- [Tentative theory](../../../../definitions/tentative-theory.md) — rests-on: the status of the theory, independent of structure or retention
- [Conjectural learning](../../../../definitions/conjectural-learning.md) — rests-on: formulated operative theory, content-directed criticism, and improved capacity
- [Addressable theory](../../../../definitions/addressable-theory.md) — rests-on: separately inspectable and editable parts as an additional property
