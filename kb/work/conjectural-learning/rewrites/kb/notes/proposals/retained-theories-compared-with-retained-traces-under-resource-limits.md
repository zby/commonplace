...
This [theory proposal](../../../../../../notes/proposals/README.md) would add
...
[retaining episode evidence](../../../../../../notes/retaining-the-episode-keeps-a-distilled-rule-re-derivable.md)
...
[the contrast actually run](../../../../../../notes/an-experiment-identifies-only-the-contrast-it-actually-runs.md),
...
- [Commonplace studies conjectural learning through retained theories](../../../../notes/commonplace-studies-conjectural-learning-through-retained-theories.md) — see-also: the independently stated efficiency conjecture
- [Retaining episode evidence keeps a distilled rule open to re-examination](../../../../../../notes/retaining-the-episode-keeps-a-distilled-rule-re-derivable.md) — grounds: records remain evidence behind retained abstractions
