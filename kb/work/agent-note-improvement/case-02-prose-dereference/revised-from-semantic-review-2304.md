...
- [a derived copy of recomputable truth must be checked or absent](./a-derived-copy-of-recomputable-truth-must-be-checked-or-absent.md) — extends: this applies the checked-copy rule to prose restatement reach; it is a synthesis from that rule, not direct evidence that a status banner instance is already established there
