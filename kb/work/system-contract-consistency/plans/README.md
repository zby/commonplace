...
| Plan | State |
|---|---|
| [T1 tag-scope closure tracker](../../tag-contract-convergence/plans/t1-tag-scope.md) | Transferred to tag-contract convergence; closes here after its adoption tests |
| [E1 Windows execution](../../execution-channel-compatibility/e1-windows-execution.md) | Owned by execution-channel compatibility; now also owns `commonplace-validate all` |
