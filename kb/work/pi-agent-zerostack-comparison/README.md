# Pi Agent Rust / Zerostack Comparison

Workshop for preparing a code-grounded comparative review of two Rust coding-agent CLIs as agentic software products and terminal user interfaces:

- `related-systems/pi_agent_rust`
- `related-systems/zerostack`
