...
| `evidenced-by`, `abstracted-from` | notes, reference, agent-memory-systems, agentic-systems, sources, external, work | the target bears on this working assertion / the workshop was abstracted from this |
