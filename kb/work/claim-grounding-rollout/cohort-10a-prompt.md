# Agent prompt — cleanup cohort 10a
...
Work cleanup cohort 10a in the Commonplace repository at
`/home/zby/llm/commonplace`.

Read `kb/work/claim-grounding-rollout/cohort-10a.md`, then
...
You own every note and ingest listed in cohort 10a and no others. Cohorts 08, 09,
