...
**Supersedes (on adoption):** [ADR 021](../../reference/adr/021-ship-library-content-under-kb-commonplace.md) (library shipped as a copy under `kb/commonplace/`) and [ADR 037](../../reference/adr/037-promote-skills-into-runtime-surfaces-by-copying.md) (skills promoted by copying)
