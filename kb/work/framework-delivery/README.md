...
2. Agents in other harnesses answer the same [probe request](./probe-request.md), reporting which outcomes they reached: Gemini CLI, OpenCode, Cursor, Goose, GitHub Copilot, and enterprise harnesses. Enterprise results may come back through the operator, anonymised.
