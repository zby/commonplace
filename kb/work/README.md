...
- [transformation-closure](./transformation-closure/README.md) — de-tautologizing the version-anchored operations proposal through worked cases: post-transformation closure in the full pass, human review anchoring, and which operations must not acquire freshness state
