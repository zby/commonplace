...
- [artifact-freshness-and-referential-checks](./artifact-freshness-and-referential-checks/README.md) — building artifact-neutral dependency baselines and reverse selection after a second consumer earns extraction of the full-pass capture, comparison, diff, and optimistic-guard boundary
