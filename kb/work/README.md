...
- [theory-register-epistemics](./theory-register-epistemics/README.md) — what the theory register admits: claims vs hypotheses vs design proposals; the existential-claim recast and a possible `epistemic-status` field
