...
- [epistack-submission](./epistack-submission/README.md) — building the actual FLF competition entry (due 19 July 2026): the "flatten the provenance, not the argument" thesis, why we do not enter on the structure layer, and the six-day build/write plan
