...
- [oolong-solver](./oolong-solver/README.md) — phase-1 empirical test of the computational-model cluster: a designed Oolong solver applying every applicable KB mechanism, attempting to beat the coding-agent SOTA
