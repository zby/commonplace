...
There are only two strategies for getting reliable output from a generator whose outputs vary — every reliability technique reduces to one of them, since the prompt admits multiple interpretations and each run renders differently:
