...
The principle: **match instruction specificity to loading frequency.** Every instruction falls into exactly one of two classes: universal rules, which load always, and task-specific rules, which load only when doing that task.
