...
- [fixed artifacts split into exact specs and proxy theories](../../../../notes/exact-implementation-does-not-validate-a-requirement.md) — foundation: the binary distinction this note refines — exact-spec artifacts have stronger verification surfaces than proxy theories
