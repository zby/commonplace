...
# The boundary of automation is the boundary of symbolic verification

Tasks become automatable when symbolic verification is cheap and resist automation when symbolic verification is expensive — regardless of raw model capability. This is not an observation about current limitations. It's a structural claim: generation without verification produces output, not automation. Where automation stalls, the bottleneck is typically oracle construction, not generation.
