...
- [deploy-time-learning](../../../../notes/deploy-time-learning-is-the-missing-middle.md) — extends the constraining gradient with a new application: output artifacts, not just code
