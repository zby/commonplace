...
Matching instruction specificity to loading frequency is the pattern that mature agent harnesses consistently converge on. The design response is progressive disclosure: match how specific an instruction is to how often it needs to be present.
