...
Use the same naming scheme for later rounds and record the round inside the report. A repeat of an environment always creates a new report and links the prior related report; it never replaces or normalizes the earlier observation.
