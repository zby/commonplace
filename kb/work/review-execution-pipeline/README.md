...
- [phase-4-job-owned-finalization.md](./phase-4-job-owned-finalization.md) - planned: finalize by job id using the job-owned output path, write result provenance frontmatter, and retire explicit ingest surfaces.
