...
| Capability or measurement limit | What could this mechanism, verifier, or evaluation distinguish even if it worked exactly as designed? | In the [Decapod curiosity experiment](../curiosity-prompts/experiment-report.md), the maintainer asked what a compiled free-form constitution could achieve; the tested agent framings did not reliably reproduce that reasoning. | Strong local motivating episode and small negative capability lead; not a stable model result. |
