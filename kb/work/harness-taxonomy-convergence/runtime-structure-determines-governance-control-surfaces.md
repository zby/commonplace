...
- [Agent runtimes decompose into scheduler context engine and execution substrate](../../notes/agent-runtimes-decompose-into-scheduler-context-engine-and-execution.md) — grounds: names the structural decomposition this note qualifies
...
- [Semantic review catches content errors that structural validation cannot](../../notes/semantic-review-catches-content-errors-that-structural-validation.md) — exemplifies: review and validation are governance operations with different oracle and cost profiles
