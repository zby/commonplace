...
- Co-Harness: **verified** — search found arXiv 2607.22688, “Co-Harness: Co-Evolving Harnesses and Model Weights for LLM Agents,” submitted 2026-07-17; its abstract says harness optimization alternates with fine-tuning on trajectories from the improved harness. Snapshot: [co-harness-co-evolving-harness-and-model-weights.md](../../sources/co-harness-co-evolving-harness-and-model-weights.md).
