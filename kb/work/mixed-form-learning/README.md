...
Decide the change-topology-matching disposition (new note vs the missing mechanism section of reflection-buys-addressability), then the vocabulary tasks and source snapshots.
