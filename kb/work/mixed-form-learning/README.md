...
| Meta-Harness evidence assessment *(added in discussion)* | **promoted** (2026-07-28), reshaped on operator review | New note: [the Meta-Harness ablation bounds summarization, not theory-formation](../../notes/the-meta-harness-ablation-bounds-summarization-not-theory-formation.md) — reshaped from a general operation-asymmetry note (judged weak as theory; the asymmetry is a corollary of commitment-not-derivation plus reach) into a dismissal-with-limits assessment: four named departures from this KB's theory, the winning arm quietly instantiating gated condensation (code-level audit of the released proposer skill), and three constraints the result does bind — episodes-to-attribution-consumers, burden of proof on our condensation bet, and the two unrun arms. The central note cites this for its Meta-Harness handling. |
