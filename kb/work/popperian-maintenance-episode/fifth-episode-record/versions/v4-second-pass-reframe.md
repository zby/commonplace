...
- [Theory-mediated self-improvement needs both interpretation and retention from one substrate](../../../../notes/reflective-theory-refinement-needs-interpretation-and-retention.md) — extends: proposes the interpreter/retention division whose Naur premise must be read with this note's narrower logical result
