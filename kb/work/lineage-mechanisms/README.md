...
- work the external-referent grounding cases (docs-on-code, outlines-on-literature) through matrix decisions 1–3, then write the external-referent review-pair design proposal in `kb/reference/proposals/` — see [external-referent-grounding-cases.md](./external-referent-grounding-cases.md);
