...
- [ ] `kb/reference/proposals/structured-output-codec-for-review-protocol.md` — revisit now that `agent({schema})` exists in the Workflow tool; the proposal's own stated adoption trigger looks met (`kb/log.md` line 22).
