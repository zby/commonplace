...
| S2; S3; S4 | Promoted to library note (defeats restated positively) | A theory-mediated loop closes only by causal co-indexing, not by co-occurrence inside one boundary | `kb/notes/a-theory-mediated-loop-closes-only-by-causal-co-indexing.md` | Argued from library notes only; validated 2026-08-28; no source grounding consumed | Reciprocal footer links added to cited notes; articles not yet reconciled |
...
| O5; T3 | Promoted to library note | Programming-tool progress is a partial order on accepted outcomes per human effort, not a scalar | `kb/notes/programming-tool-progress-is-a-partial-order-not-a-scalar.md` | Argued from library notes only; validated 2026-08-28; no source grounding consumed | Reciprocal footer links added to cited notes; articles not yet reconciled |
| C4; C1 | Promoted to library note | Explicit artifacts buy addressability, not credit assignment, coherence, retrieval, or admission | `kb/notes/explicit-artifacts-buy-addressability-not-credit-assignment.md` | Argued from library notes only; validated 2026-08-28; no source grounding consumed | Reciprocal footer links added to cited notes; articles not yet reconciled |
| O3; T6 | Promoted to library note | Removing a human judgment can degrade the judgments that remain | `kb/notes/removing-a-human-judgment-can-degrade-the-judgments-that-remain.md` | Argued from library notes only; validated 2026-08-28; no source grounding consumed | Reciprocal footer links added to cited notes; articles not yet reconciled |
