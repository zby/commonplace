# Agentic-system learning refoundation

Workshop opened 2026-08-31 to hold deferred material from a review of an
earlier program-article version. The article was subsequently rewritten; the
material here remains historical input or unresolved protocol work and must be
...
- [faithfulness-audit-2026-08-31.md](./faithfulness-audit-2026-08-31.md) —
  ...
  findings about the rewritten article.
- [random-mutation-defense.md](./random-mutation-defense.md) — position paper
  defending weak theory-guided search against the "random mutation also
...
**Closure.** Closes when each still-live finding is folded into the article and
...
in prose; the faithfulness audit records fidelity findings for an earlier
article version.
