...
- [Canonical files may defer a shared schema while database authority remains a separate commitment](./files-defer-centralized-schema-commitment-until-invariants-stabilize.md) — contrasts: schema deferral protects against unsettled meaning, while this note addresses entrenchment after a structure already fits current tasks
