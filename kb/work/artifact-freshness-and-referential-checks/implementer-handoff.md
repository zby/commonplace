...
**Start here.** Authority chain: this file →
[implementation-plan.md](./implementation-plan.md) →
[database-design.md](./database-design.md) → the live
...
| gate | deliverable |
|---|---|
| **M1** | `file-text` schema, live JSON serializer/parser behavior, migration script + fixtures (skip 4 dead baselines; fail job `49`) |
