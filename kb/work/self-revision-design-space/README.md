...
1. **Resolved by the [hostile reading](./hostile-reading.md):** several papers make narrower organizational redesign operative; the claim survives only per named redesign class, not as a binary placement of whole systems.
...
- [Hostile reading](./hostile-reading.md) — strongest counterexamples, the aspect-bounded correction, and article-integration consequences.
