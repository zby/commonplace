...
The three completed case tests are in [Discriminating tests](./discriminating-tests.md). The [hostile reading](./hostile-reading.md) forced the aspect-bounded correction and has been integrated into the note and article; the formal model remains backstage because the corrected comparison can be stated in plain language.
