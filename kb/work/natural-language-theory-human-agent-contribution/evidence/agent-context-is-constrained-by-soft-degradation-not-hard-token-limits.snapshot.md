<!-- Frozen copy of kb/notes/agent-context-is-constrained-by-soft-degradation-not-hard-token-limits.md, captured 2026-08-18. Do not update this evidence file when the source changes. -->
