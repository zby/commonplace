<!-- Frozen copy of kb/notes/discovery-README.md, captured 2026-08-18. Do not update this evidence file when the source changes. -->
...
- [conjecture is seeing the particular as an instance of the general](./conjecture-is-seeing-the-particular-as-an-instance-of-the-general.md) — the dual structure (posit the general, recognize the particular); three depths from shared feature to generative model; the hard problem is recognition, not linking
...
- [natural-language theories carry warrant claim by claim and scope by scope](./natural-language-theories-carry-warrant-claim-by-claim.md) — separates theory-bearing capacity from warrant: criticizable structure makes reach assessable, while support licenses only interpreted claims over bounded scopes
