...
## The forward question: who invents the epistemology-derived machinery

When the note's mechanisms are folded into writing or review machinery, the workshop's main question becomes how much of that machinery was invented by agents. The criterion is fuzzy — "invented" is not yet operationalized the way note-attribution was — and may be made stricter before it is applied. What can be fixed now is the method: capture the folding episode contemporaneously (the second episode's record shows the difference that makes), and attribute interventions — which mechanism, default, or check entered through whose move — rather than counting prose.
