...
Mode: exact snapshot (frontmatter removed, title normalized, provenance header added)
Frozen source tag: pending
Source paths: kb/articles/reachability-as-closure-under-the-seed-gate.md
