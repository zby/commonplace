...
- Sutton, Richard S. 2019. "The Bitter Lesson." Essay.
  ...
  kb/sources/sutton-the-bitter-lesson-original-essay.ingest.md.

## Constructions compared in Supplement D
...
- OpenAI agent-first product. Lopopolo, Ryan. 2026. "Harness Engineering:
  ...
  <https://openai.com/index/harness-engineering/>. Product report. Provenance:
  kb/sources/harness-engineering-leveraging-codex-agent-first-world.ingest.md.
- Warp skill improver. Segner, Michael. 2026. "How Warp builds self-improving
  agents on Claude." Anthropic customer story.
  <https://claude.com/blog/how-warp-builds-self-improving-agents-on-claude>.
  Practitioner report. Provenance:
  kb/sources/how-warp-builds-self-improving-agents-on-claude.ingest.md.
- Darwin Gödel Machine. Zhang, Jenny, Shengran Hu, Cong Lu, Robert Lange, and
  Jeff Clune. 2026. "Darwin Gödel Machine: Open-Ended Evolution of
  Self-Improving Agents." ICLR 2026. arXiv:2505.22954 (v3 read).
  <https://arxiv.org/abs/2505.22954>. Paper. Provenance:
  kb/sources/darwin-godel-machine-open-ended-evolution-self-improving-agents.ingest.md.
- Huxley-Gödel Machine. Wang, Wenyi, Piotr Piękos, Li Nanbo, Firas Laakom,
  Yimeng Chen, Mateusz Ostaszewski, Mingchen Zhuge, and Jürgen Schmidhuber.
