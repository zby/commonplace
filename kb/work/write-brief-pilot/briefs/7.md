...
- [restored] The instruction passes only if both trial agents can execute it without clarification, keep source/doctrine/report distinctions, and produce different route-level findings appropriate to the systems.

## Removed

Operator review 2026-09-26 restored the executability acceptance line, marked [restored] at the end of "Known uncertainties and acceptance criteria": it states a lasting property of the instruction, not only a test of that run.
