...
An executable procedure tracing, route by route, whether an external system earns warrant for truth-apt content or merely stores, reshapes, or uses it; storage or fluent synthesis alone never counts as knowledge production.
