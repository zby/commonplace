...
Argue that a theory's prototype standing is its expected revision cost (external binding plus lost investment), not its form or acceptance status; keep the cheap-formalization paragraph, which the bitter-lesson portfolio note relies on.
