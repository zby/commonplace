...
- *The concession*: methodology, heuristics, and conventions may migrate into weights as models absorb stable guidance, and such structure should be [relaxed or removed](./codification-and-relaxing-navigate-the-bitter-lesson-boundary.md) when it stops earning its marginal value. The concession does not cover the KB's core vocabulary: that vocabulary is now settled enough to commit to.
