...
Outside readers' entry article to the research program: the theory-builder conjecture, its three hypotheses and refuters, Commonplace as first arrangement; never call Commonplace a software house or imply a run exists.
