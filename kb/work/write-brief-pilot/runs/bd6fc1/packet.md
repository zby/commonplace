...
Classify the operator's gradual bitter-lesson position (compatibility per portion of a path) as a self-bounding portfolio row; keep the standing concession, state no proportion, and report if it only restates an existing row.
