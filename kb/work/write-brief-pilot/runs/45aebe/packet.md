...
Design an agent memory system on the premise that storing everything, session logs included, is cheap and the hard part is activation under bounded context; keep 'store everything' a hypothesis whose costs stay open questions.
