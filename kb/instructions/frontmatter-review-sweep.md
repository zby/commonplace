---
description: Batch frontmatter review across all notes in kb/notes/. Delegates each note to a sub-agent running frontmatter-review, saves individual reports, then writes a summary with aggregate findings.
---
