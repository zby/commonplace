...
**Experimental.** This is the conservative note-revision adaptation of AutoReason, based on `related-systems/autoreason/`. Use it when you want to test the tournament workflow.
...
- Begin with: `This task is the complete role brief. Ignore auto-loaded
  revision or orchestration skills, including cp-skill-revise-autoreason. Do
  not spawn or delegate to another agent.`
