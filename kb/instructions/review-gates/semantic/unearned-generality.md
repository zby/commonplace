...
5. **Check whether the explanatory-reach is argued.** Generality earned by argument passes even when step 2 leaves the primary argument intact — the note says why the mechanism does not depend on the narrower term, and ideally exhibits a second instance under the general term. A single instance class with no such argument is what makes an abstraction unearned.
