...
A specialized sub-procedure for description-field warnings from `/validate`. Called standalone or by the general fix instruction when it encounters description issues.
