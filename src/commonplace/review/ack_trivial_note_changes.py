...
trivial against it. Conformance pairs rely on this — type specs, COLLECTION.md
contracts, and source ingests do not declare `watches:`, which is what keeps
them safe to select here via `--all-gates`.
"""
