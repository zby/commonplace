...
trivial against it. Conformance pairs rely on this — type specs and
COLLECTION.md contracts do not declare `watches:`, which is what keeps them
safe to select here via `--all-gates`.
"""
