...
- **Representational form:** `natural-language` `symbolic` `parametric` — natural-language memory content, symbolic metadata/scores/graph edges/rules, and distributed-parametric embeddings/HDC vectors plus FTS tokens
...
- **Distilled form:** `natural-language` `symbolic` `parametric` — compressed natural-language memories, symbolic schemas/rules, and embedding/HDC vectors
