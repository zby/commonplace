---
name: write
description: Write a KB artifact using the default note workflow or a discovered type template. Routes by type, reads WRITING.md, searches first, and validates after writing. Triggers on "/write", "/write [type]", "/write [type] [topic]".
user-invocable: true
