...
review_db = load_module("review_db_repair_codex_model_partitions_test", SCRIPTS_DIR / "review_db.py")
...
def test_repair_codex_model_partitions_rekeys_review_artifacts(tmp_path: Path) -> None:
    ...
    result = subprocess.run(
        [sys.executable, str(SCRIPTS_DIR / "repair_codex_model_partitions.py")],
        cwd=REPO_ROOT,
        env=env,
        check=True,
        capture_output=True,
