...
review_db = load_module("review_db_prune_manual_import_test", SCRIPTS_DIR / "review_db.py")
...
def test_prune_superseded_unknown_manual_import_reviews_deletes_only_superseded_rows(
    ...
    result = subprocess.run(
        [sys.executable, str(SCRIPTS_DIR / "prune_superseded_unknown_manual_import_reviews.py")],
        cwd=REPO_ROOT,
        env=env,
        check=True,
        capture_output=True,
