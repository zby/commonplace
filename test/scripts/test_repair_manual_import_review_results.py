...
review_db = load_module("review_db_repair_manual_import_test", SCRIPTS_DIR / "review_db.py")
...
""",
    ...
    result = subprocess.run(
        [sys.executable, str(SCRIPTS_DIR / "repair_manual_import_review_results.py")],
        cwd=REPO_ROOT,
        env=env,
        check=True,
        capture_output=True,
