...
Frontloading is partial evaluation applied to a domain where the "program" being specialised has [underspecified semantics](../notes/agentic-systems-interpret-underspecified-instructions.md).
...
**1. The "program" has underspecified semantics.** Natural language instructions don't have precise denotations. This is the property that [distinguishes LLM-based systems from traditional programming](../notes/agentic-systems-interpret-underspecified-instructions.md). There is no exact `[[P]]` — the instruction admits a space of valid interpretations.
