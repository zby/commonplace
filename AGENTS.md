...
- **Tentative theory** — Popper's term, borrowed as is: an addressable theory put forward as a solution and held open to criticism and revision; the status of every theory the KB retains, which licenses no particular use. Replaced the KB's earlier *fallible theory* on 2026-09-17. See `kb/notes/definitions/theory-refinement.md#tentative-theory`.
...
- **Theory builder** — the complete persistent system responsible for developing and revising tentative theories about the subjects it investigates, including every person or component in an internal theory-building role; identified by continuity of responsibility and lineage, not by any component, and assessed against a declared boundary, seed, and evidence interface. *Reflective* and *autonomous* are its two independent conditions. See `kb/notes/definitions/theory-builder.md`.
